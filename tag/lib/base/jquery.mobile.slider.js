	...
	_create: function() {
		...
		var self = this,
			...
			valuebg = control.jqmData("highlight") && cType != "select" ? (function() {
                ...
                {
                    bg.className = 'ui-slider-semicircle-highlight-cut';
                    var bgInner = document.createElement('div');
                    bgInner.className = 'ui-slider-semicircle ui-btn-active';
		...
		domSlider.className = ['ui-slider' + (orientation ? "-" + orientation : " "),selectClass," ui-btn-down-",trackTheme,' ui-btn-corner-all', inlineClass, miniClass].join("");
        ...
        if (orientation == 'semicircle')
        {
            ...
            domSliderLeft.className = 'ui-slider-semicircle-bottom ' + (valuebg ? 'ui-btn-active ' : '') +'ui-btn-down-' + trackTheme;
