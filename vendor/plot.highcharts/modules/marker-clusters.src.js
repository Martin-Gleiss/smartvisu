...
var markerClusterAlgorithms = {
    ...
    kmeans: function (dataX, dataY, dataIndexes, options) {
        ...
        var series = this,
            ...
            noise = [],
            group = {},
            pointMaxDistance = Number((_a = options.processedDistance) !== null && _a !== void 0 ? _a : (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(options.distance ||
    ...
    optimizedKmeans: function (processedXData, processedYData, dataIndexes, options) {
        ...
        if (!series.markerClusterInfo || (series.initMaxX && series.initMaxX < extremes.maxX ||
            ...
            (_b = series.baseClusters) !== null && _b !== void 0 ? _b : (series.baseClusters = {
                clusters: series.markerClusterInfo.clusters,
                noise: series.markerClusterInfo.noise
            });
            for (var _i = 0, _h = series.baseClusters.clusters; _i < _h.length; _i++) {
                var cluster = _h[_i];
                cluster.pointsOutside = [];
                cluster.pointsInside = [];
                for (var _j = 0, _k = cluster.data; _j < _k.length; _j++) {
                    var dataPoint = _k[_j];
                    ...
                    var radius = ((_g = (_f = (_e = (_d = (_c = cluster.clusterZone) === null || _c === void 0 ? void 0 : _c.marker) === null || _d === void 0 ? void 0 : _d.radius) !== null && _e !== void 0 ? _e : clusterMarkerOptions === null || clusterMarkerOptions === void 0 ? void 0 : clusterMarkerOptions.radius) !== null && _f !== void 0 ? _f : clusterDefaults.marker.radius) !== null && _g !== void 0 ? _g : 0);
                    var offset = pointMaxDistance - radius >= 0 ?
                            pointMaxDistance - radius : radius;
                    if (distance > radius + offset &&
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(cluster.pointsOutside)) {
                        cluster.pointsOutside.push(dataPoint);
                    }
                    else if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(cluster.pointsInside)) {
                ...
                var i = 0;
                for (var _l = 0, _m = cluster.pointsOutside; _l < _m.length; _l++) {
                    var p = _m[_l];
                    group[cluster.id + '_noise' + i++] = [p];
                }
            }
            for (var _o = 0, _p = series.baseClusters.noise; _o < _p.length; _o++) {
                var noise = _p[_o];
...
function compose(highchartsDefaultOptions, ScatterSeriesClass) {
    ...
    if (!scatterProto.markerClusterAlgorithms) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ScatterSeriesClass, 'destroy', scatterProto.destroyClusteredData);
        if (highchartsDefaultOptions.plotOptions) {
            highchartsDefaultOptions.plotOptions.series = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(highchartsDefaultOptions.plotOptions.series, MarkerClusters_MarkerClusterDefaults);
        }
    }
}
/**
 ...
 * @internal
 */
function fadeInNewPointAndDestroyOld(newPointObj, oldPoints, animation, opacity) {
    var _a,
        _b;
    // Fade in new point.
...
function onPointDrillToCluster(event) {
    ...
    point.firePointEvent('drillToCluster', event, function (e) {
        ...
        var point = e.point || e.target,
            ...
            drillToCluster = (_d = series.options
                .cluster) === null || _d === void 0 ? void 0 : _d.drillToCluster;
...
function seriesAnimateClusterPoint(clusterObj) {
    ...
    if (oldState && newState) {
        ...
        if (newPointObj.parentsId.length === 1) {
                ...
                if (oldState === null || oldState === void 0 ? void 0 : oldState[elem]) {
                    ...
                    if ((_a = oldPointObj.point) === null || _a === void 0 ? void 0 : _a.graphic) {
                        ...
                        oldPointObj.point.graphic.animate({
                            ...
                            isCbHandled = true;
                            fadeInNewPointAndDestroyOld(newPointObj, oldPoints, animation, 0.7);
                        });
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.syncTimeout)(function () {
                if (!isCbHandled) {
                    fadeInNewPointAndDestroyOld(newPointObj, oldPoints, animation, 0.85);
                }
            }, animDuration);
            if (!isOldPointGraphic) {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.syncTimeout)(function () {
                    fadeInNewPointAndDestroyOld(newPointObj, oldPoints, animation, 0.1);
                }, animDuration / 2);
            }
        }
    }
...
function seriesGeneratePoints() {
    ...
    if ((clusterOptions === null || clusterOptions === void 0 ? void 0 : clusterOptions.enabled) &&
        ...
        layoutAlgOptions.processedGridSize = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(layoutAlgOptions.gridSize ||
            clusterDefaults.layoutAlgorithm.gridSize, chart.plotWidth);
        layoutAlgOptions.processedDistance = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(layoutAlgOptions.distance ||
        ...
        for (var i = 0; i < xData.length; i++) {
            if (!series.dataMaxX) {
                if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMaxX) ||
                    !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMinX) ||
                    !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMaxY) ||
                    !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMinY)) {
                    seriesMaxX = seriesMinX = xData[i];
                    seriesMaxY = seriesMinY = yData[i];
                }
                else if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yData[i]) &&
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(seriesMaxY) &&
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(seriesMinY)) {
        ...
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMaxX) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(seriesMinX) &&
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(seriesMaxY) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(seriesMinY)) {
            series.dataMaxX = seriesMaxX;
            series.dataMinX = seriesMinX;
            series.dataMaxY = seriesMaxY;
            series.dataMinY = seriesMinY;
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isFunction)(type)) {
            algorithm = type;
        }
        ...
        if (clusteredData && series.markerClusterInfo) {
            ...
            (_d = series.markerClusterInfo.clusters) === null || _d === void 0 ? void 0 : _d.forEach(function (cluster) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(point, 'click', onPointDrillToCluster);
            });
...
function seriesGetClusteredData(groupedData, options) {
    ...
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isFunction)(options.layoutAlgorithm.type) &&
        !series.isValidGroupedDataObject(groupedData)) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Highcharts marker-clusters module: ' +
        ...
        if (groupedData[k].length >= minimumClusterSize) {
            ...
            if (options.layoutAlgorithm.type === 'grid' &&
                ...
                clusterPos = series.preventClusterCollisions({
                    ...
                    clusterRadius: (_d = (_c = (_a = zoneOptions === null || zoneOptions === void 0 ? void 0 : zoneOptions.radius) !== null && _a !== void 0 ? _a : (_b = options.marker) === null || _b === void 0 ? void 0 : _b.radius) !== null && _c !== void 0 ? _c : clusterDefaults.marker.radius) !== null && _d !== void 0 ? _d : 0
                });
            }
            else {
                clusterPos = {
            ...
            groupMap.push({
                options: {
                    ...
                    marker: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.marker, {
            ...
            if (data === null || data === void 0 ? void 0 : data.length) {
                for (var i = 0; i < pointsLen; i++) {
                    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(data[points[i].dataIndex])) {
            ...
            for (var i = 0; i < groupedData[k].length; i++) {
                ...
                if (pointUserOptions &&
                    ...
                    !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(pointUserOptions)) {
                    pointOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(pointUserOptions, { x: point.x, y: point.y });
                }
                else {
                    pointOptions = {
...
function seriesGetScaledGridSize(options) {
    ...
    var series = this,
        ...
        processedGridSize = Number((_a = options.processedGridSize) !== null && _a !== void 0 ? _a : (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(options.gridSize || clusterDefaults.layoutAlgorithm.gridSize,
        series.chart.plotWidth));
    var search = true,
        k = 1,
        divider = 1;
...
function seriesIsValidGroupedDataObject(groupedData) {
    ...
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(groupedData, function (elem) {
        ...
        for (var i = 0; i < elem.length; i++) {
            if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(elem[i]) || (!elem[i].x || !elem[i].y)) {
                result = false;
                return;
            }
        }
...
function seriesPreventClusterCollisions(props) {
    ...
    var _b,
        ...
        _e;
    var series = this,
        _f = props.key.split(':').map(parseFloat),
        gridY = _f[0],
        gridX = _f[1],
            ...
            if (zoneOptions) {
                ...
                for (var i = 0; i < zoneOptions.length; i++) {
                    if (pointsLen >= zoneOptions[i].from &&
                        ...
                        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)((_d = zoneOptions[i].marker) === null || _d === void 0 ? void 0 : _d.radius)) {
                            ...
                            radius = (_e = clusterDefaults.marker.radius) !== null && _e !== void 0 ? _e : 0;
                        }
                    }
                }
            }
 ...
 *
 * */
(defaultOptions.plotOptions || {}).series = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)((defaultOptions.plotOptions || {}).series, MarkerClusters_MarkerClusterDefaults);
/* *
 *
 *  Functions
 *
...
function MarkerClusters_compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'MarkerClusters')) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(PointClass, 'drillToCluster', MarkerClusters_onPointDrillToCluster);
...
function MarkerClusters_onPointDrillToCluster(event) {
    ...
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isFunction)(onDrillToCluster)) {
...
function onSeriesAfterRender() {
    var series = this,
        clusterZoomEnabled = (series.options.cluster || {})
            .drillToCluster;
    if (series.markerClusterInfo && series.markerClusterInfo.clusters) {
        for (var _i = 0, _a = series.markerClusterInfo.clusters; _i < _a.length; _i++) {
            ...
            if (cluster.point && cluster.point.graphic) {
                ...
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(cluster.clusterZone)) {
