 ...
 *
 * */
var Utilities_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
function merge(extendOrSource) {
    ...
    var i,
        args = Utilities_spreadArray([extendOrSource],
        sources,
        true),
        ret = {};
...
var markerClusterAlgorithms = {
    ...
    kmeans: function (dataX, dataY, dataIndexes, options) {
        ...
        var series = this,
            ...
            noise = [],
            group = {},
            pointMaxDistance = Number((_a = options.processedDistance) !== null && _a !== void 0 ? _a : relativeLength(options.distance ||
...
function seriesGetScaledGridSize(options) {
    ...
    var series = this,
        ...
        processedGridSize = Number((_a = options.processedGridSize) !== null && _a !== void 0 ? _a : relativeLength(options.gridSize || clusterDefaults.layoutAlgorithm.gridSize,
        series.chart.plotWidth));
    var search = true,
        k = 1,
        divider = 1;
