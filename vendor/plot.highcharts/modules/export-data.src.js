...
(function (ExportData) {
    ...
    function compose(ChartClass, ExportingClass, SeriesClass) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'ExportData')) {
            return;
        }
        ...
        if (!exportingProto.downloadCSV) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'afterViewData', onChartAfterViewData);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'render', onChartRenderer);
    ...
    function getDataRows(multiLevelHeaders) {
        ...
        getCategoryAndDateTimeMap = function (series, pointArrayMap, pIdx) {
            ...
            pointArrayMap.forEach(function (prop) {
                var axisName = ((series.keyToAxis && series.keyToAxis[prop]) ||
                    ...
                    axis = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(pIdx) ?
        ...
        chart.series.forEach(function (series) {
            ...
            if (series.options.includeInDataExport !== false &&
                ...
                if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(xAxisIndices, function (index) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'exportData', { dataRows: dataRows });
        return dataRows;
    }
    /**
    ...
    function getTableAST(useLocalDecimalPoint) {
        ...
        getCellHTMLFromValue = function (tagName, classes, attributes, value) {
            ...
            attributes = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ 'class': className }, attributes);
            var result = {
                    tagName: tagName,
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'afterGetTableAST', e);
        return e.tree;
    }
    /**
    ...
    function toggleDataTable(show) {
        ...
        if (this.dataTableDiv) {
            ...
            if (show) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'afterViewData', {
                    element: this.dataTableDiv,
                    wasHidden: createContainer || oldDisplay !== style.display
                });
            }
            else {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'afterHideData');
            }
        }
        // Set the flag
    ...
    function onChartAfterViewData() {
        var exporting = this.exporting, dataTableDiv = exporting === null || exporting === void 0 ? void 0 : exporting.dataTableDiv, langOptions = this.options.lang, decimalPoint = (langOptions === null || langOptions === void 0 ? void 0 : langOptions.decimalPoint) || '.', thousandsSep = (langOptions === null || langOptions === void 0 ? void 0 : langOptions.thousandsSep) || ',', getCellValue = function (tr, index) {
            ...
            return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(number) ? number : null;
        }, comparer = function (index, ascending) {
            return function (a, b) {
                var valA = getCellValue(ascending ? a : b,
                    index),
                    valB = getCellValue(ascending ? b : a,
                    index),
