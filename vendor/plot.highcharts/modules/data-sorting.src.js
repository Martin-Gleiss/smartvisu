...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ data_sorting_src; }
});

// EXTERNAL MODULE: external {"amd":["highcharts/highcharts"],"commonjs":["highcharts"],"commonjs2":["highcharts"],"root":["Highcharts"]}
var highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_ = __webpack_require__(944);
var highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default = /*#__PURE__*/__webpack_require__.n(highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_);
;// ./code/es5/es-modules/Extensions/DataSorting/DataSortingComposition.js
/* *
 *
 *  (c) 2025-2025 Torstein Honsi
 *
...
function sortData(series, data) {
    var options = series.options,
        _a = (options.dataSorting || {}).sortKey,
        sortKey = _a === void 0 ? 'y' : _a,
        getPointOptionsObject = function (series,
        pointOptions) {
            return ((0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(pointOptions) &&
    ...
    var sortedData = data.concat().sort(function (a,
        b) {
            var aValue = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(sortKey,
        a);
        var bValue = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(sortKey,
            b);
...
function compose(ChartClass, SeriesClass) {
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(SeriesClass.prototype, 'setData', function (proceed, data) {
        var _a;
        var args = [];
    ...
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'afterAddSeries', function (_a) {
...
/* harmony default export */ var DataSorting_DataSortingComposition = (DataSortingComposition);

;// ./code/es5/es-modules/masters/modules/data-sorting.src.js
...
/* harmony default export */ var data_sorting_src = ((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()));
