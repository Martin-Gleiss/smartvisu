...
var TreegraphPoint = /** @class */ (function (_super) {
    ...
    TreegraphPoint.prototype.renderCollapseButton = function () {
        var point = this,
            ...
            btnOptions = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(series.options.collapseButton,
        ...
        if (!point.collapseButton) {
            ...
            point.collapseButton = chart.renderer
                ...
                .css((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(TreegraphPoint, 'mouseOver', function () {
    var _a,
        _b;
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(TreegraphPoint, 'click', function () {
    this.toggleCollapse();
});
/* *
 *
...
var TreegraphSeries = /** @class */ (function (_super) {
    ...
    TreegraphSeries.prototype.init = function () {
        ...
        var series = this,
            ...
            if (series.options.dataLabels &&
                !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(series.options.dataLabels)[0].allowOverlap) {
    ...
    TreegraphSeries.prototype.getLayoutModifiers = function () {
        ...
        var chart = this.chart,
            ...
            columnCount = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(this.points.map(function (p) { return p.node.xPosition; }));
        var minX = Infinity,
            maxX = -Infinity,
            minY = Infinity,
            maxY = -Infinity,
        ...
        this.points.forEach(function (point) {
            ...
            var node = point.node,
                ...
                markerOptions = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(_this.options.marker,
                level.marker,
                point.options.marker),
                nodeWidth = (_a = markerOptions.width) !== null && _a !== void 0 ? _a : TreegraphSeries_getNodeWidth(_this,
                columnCount),
                radius = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(markerOptions.radius || 0,
                Math.min(plotSizeX,
                plotSizeY)),
                ...
                nodeSizeY = (symbol === 'circle' || !markerOptions.height) ?
                    radius * 2 :
                    (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(markerOptions.height,
                plotSizeY),
                nodeSizeX = symbol === 'circle' || !nodeWidth ?
                    radius * 2 :
                    (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(nodeWidth,
                plotSizeX);
    ...
    TreegraphSeries.prototype.getLinks = function () {
        ...
        this.data.forEach(function (point) {
            ...
            if (point.node.parent) {
                var pointOptions = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(levelOptions,
                    point.options);
    ...
    TreegraphSeries.prototype.translateLink = function (link) {
        ...
        if (fromNode.shapeArgs && toNode.shapeArgs) {
            var fromNodeWidth = (fromNode.shapeArgs.width || 0),
                ...
                y1 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((fromNode.shapeArgs.y || 0) +
                    (fromNode.shapeArgs.height || 0) / 2,
                linkWidth),
                y2 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((toNode.shapeArgs.y || 0) +
                    (toNode.shapeArgs.height || 0) / 2,
                linkWidth);
            var x1 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((fromNode.shapeArgs.x || 0) + fromNodeWidth,
                linkWidth),
                x2 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(toNode.shapeArgs.x || 0,
                linkWidth);
            if (inverted) {
    ...
    TreegraphSeries.prototype.drawNodeLabels = function (points) {
        ...
        for (var _i = 0, points_1 = points; _i < points_1.length; _i++) {
            ...
            if (level && level.dataLabels) {
                options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options, level.dataLabels);
            ...
            if (point.shapeArgs &&
                ...
                if (!((_b = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(series.options.dataLabels)[0].style) === null || _b === void 0 ? void 0 : _b.width)) {
                    css.width = "" + width + "px";
                }
    ...
    TreegraphSeries.prototype.drawDataLabels = function () {
        if (this.options.dataLabels) {
            this.options.dataLabels = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(this.options.dataLabels);
            // Render node labels.
    ...
    TreegraphSeries.prototype.translateNode = function (point) {
        var chart = this.chart,
            ...
            markerOptions = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.marker,
            level.marker,
            point.options.marker),
            symbol = markerOptions.symbol,
        ...
        if (!point.visible && point.linkToParent) {
            ...
            if (parentNode) {
                ...
                if (!point.hasImage) {
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(point.shapeArgs, {
