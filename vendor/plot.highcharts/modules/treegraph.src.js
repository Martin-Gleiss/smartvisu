...
var TreegraphSeries = /** @class */ (function (_super) {
    ...
    TreegraphSeries.prototype.translateLink = function (link) {
        ...
        var fromNode = link.fromNode,
            ...
            factor = pick((_b = this.options.link) === null || _b === void 0 ? void 0 : _b.curveFactor, 0.5),
            hasXData = toNode.x !== toNode.node.level ||
                fromNode.x !== fromNode.node.level,
            type = pick((_c = link.options.link) === null || _c === void 0 ? void 0 : _c.type, (_d = this.options.link) === null || _d === void 0 ? void 0 : _d.type, 'default');
    ...
    TreegraphSeries.defaultOptions = merge(TreemapSeries.defaultOptions, Treegraph_TreegraphSeriesDefaults);
