...
var Oscillator = /** @class */ (function () {
    ...
    Oscillator.prototype.scheduleFilterTrackingChange = function (frequency, time, glideDuration) {
        var opts = this.options,
            ...
            frequency),
            f = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)((filterOptions.frequency || 1000) * multiplier, 0, 21000);
...
var SynthPatch = /** @class */ (function () {
    function SynthPatch(audioContext, options) {
        ...
        this.oscillators = (this.options.oscillators || []).map(function (oscOpts) { return new Oscillator(audioContext, oscOpts, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(oscOpts.fmOscillator) || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(oscOpts.vmOscillator) ?
            void 0 : inputNode); });
        ...
        this.oscillators.forEach(function (osc) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(osc.fmOscillatorIx)) {
                connectTarget('getFMTarget', _this.oscillators[osc.fmOscillatorIx]);
            }
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(osc.vmOscillatorIx)) {
...
var SonificationInstrument = /** @class */ (function () {
    function SonificationInstrument(audioContext, outputNode, options) {
        ...
        this.createNodesFromCapabilities((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({
            pan: true
    ...
    SonificationInstrument.prototype.scheduleEventAtTime = function (time, params) {
        var mergedParams = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(this.curParams,
            params),
            freq = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(params.frequency) ?
                params.frequency : (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(params.note) ?
                SonificationInstrument.musicalNoteToFrequency(params.note) :
                220;
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(freq)) {
            this.synthPatch.playFreqAtTime(time, freq, mergedParams.noteDuration);
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.tremoloDepth) ||
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.tremoloSpeed)) {
            this.setTremoloAtTime(time, mergedParams.tremoloDepth, mergedParams.tremoloSpeed);
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.pan)) {
            this.setPanAtTime(time, mergedParams.pan);
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.volume)) {
            this.setVolumeAtTime(time, mergedParams.volume);
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.lowpassFreq) ||
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.lowpassResonance)) {
            this.setFilterAtTime('lowpass', time, mergedParams.lowpassFreq, mergedParams.lowpassResonance);
        }
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.highpassFreq) ||
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(mergedParams.highpassResonance)) {
    ...
    SonificationInstrument.prototype.setFilterAtTime = function (filter, time, frequency, resonance) {
        ...
        if (node) {
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(resonance)) {
                node.Q.setTargetAtTime(resonance, audioTime, SonificationInstrument.rampTime);
            }
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(frequency)) {
    ...
    SonificationInstrument.prototype.setTremoloAtTime = function (time, depth, speed) {
        ...
        if (this.tremoloDepth && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(depth)) {
            this.tremoloDepth.gain.setTargetAtTime(depth, audioTime, SonificationInstrument.rampTime);
        }
        if (this.tremoloOsc && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(speed)) {
...
function filterChannels(filter, channels) {
    ...
    return filtered.map(function (c) { return (new Sonification_TimelineChannel(c.channel.type, c.channel.engine, c.channel.showPlayMarker, c.filteredEvents.map(function (e) {
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(e, { time: e.time - minTime });
    }), c.channel.muted)); });
}
/**
                    ...
                    _this.scheduledCallbacks.push(setTimeout(function () {
                        ...
                        if (point) {
                            ...
                            chart && chart.hoverPoints &&
                                ...
                                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(chart.hoverPoints, function (p) { return p === point; }) &&
        ...
        (this.playingChannels || this.channels).forEach(function (channel) {
            ...
            while (i--) {
                ...
                var val = events[i].relatedPoint[prop],
                    diff = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(val) && Math.abs(targetVal - val);
...
function getPointPropValue(point, prop) {
    ...
    if (prop) {
        ...
        ret = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(prop, point);
    }
...
function getChartExtremesForProps(chart, props, perSeriesProps) {
    var series = chart.series,
        ...
        var val = point[prop];
        if (val === void 0) {
            val = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(prop, point);
        }
    ...
    chart.series.forEach(function (series) {
        ...
        if (series.visible && !(sOpts && sOpts.enabled === false)) {
            if (hasCommonTimeProps) {
                seriesTimeProps[series.index] = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(commonTimeProps);
            }
            if (sOpts) {
...
function mapToVirtualAxis(value, valueExtremes, virtualAxisExtremes, invert, logarithmic // Virtual axis is logarithmic
    ...
    return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(val, virtualAxisExtremes.min, virtualAxisExtremes.max);
}
/**
...
function getMappingParameterValue(context, propMetrics, useSeriesExtremes, defaultMapping, mappingOptions, contextValueProp) {
    ...
    if (typeof mappingOptions === 'function') {
        return mappingOptions((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ time: 0 }, context));
    }
    ...
    if (!useContextValue) {
        ...
        if (value === void 0) {
            value = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(mapTo, context.point);
        }
    }
    ...
    if (context.point) {
        if (within === 'xAxis' || within === 'yAxis') {
            ...
            if (axis && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(axis.dataMin) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(axis.dataMax)) {
                extremes = {
                    min: axis.dataMin,
                    max: axis.dataMax
                };
        ...
        if (eventOpts.note > -1) {
            ...
            eventsAdded.push(channel.addEvent({
                ...
                instrumentEventOptions: ix !== void 0 ?
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({}, eventOpts) : eventOpts
            }));
        }
    };
    ...
    chart.series.forEach(function (series, seriesIx) {
        ...
        if (series.visible && sOptions.enabled !== false) {
            var seriesDuration_1 = isSequential ? getAvailableDurationForSeries(series,
                ...
                seriesDefaultInstrOpts_1 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultInstrOpts,
                sOptions.defaultInstrumentOptions),
                seriesDefaultSpeechOpts_1 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultSpeechOpts,
                sOptions.defaultSpeechOptions),
                seriesPointGroupOpts_1 = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultPointGroupOpts,
...
var Sonification = /** @class */ (function () {
    function Sonification(chart) {
        ...
        this.lastUpdate = 0;
        this.chart = chart;
        this.unbindKeydown = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(Sonification_doc, 'keydown', function (e) {
    ...
    Sonification.prototype.speak = function (text, speakerOptions, delayMs) {
        if (delayMs === void 0) { delayMs = 0; }
        var speaker = new Sonification_SonificationSpeaker((0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
                language: 'en-US',
                rate: 1.5,
                volume: 0.4
    ...
    Sonification.prototype.update = function () {
        ...
        if (now - this.lastUpdate < updateInterval && !this.forceReady) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.internalClearTimeout)(this.scheduledUpdate);
    ...
    Sonification.prototype.initBoundaryInstrument = function () {
        if (!this.boundaryInstrument) {
            this.boundaryInstrument = new Sonification_SynthPatch(this.audioContext, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(Sonification_InstrumentPresets.chop, { masterVolume: 0.3 }));
...
(function (Sonification) {
    ...
    function chartOnUpdate(e) {
        ...
        if (newOptions) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, this.options.sonification, newOptions);
    ...
    function compose(ChartClass, SeriesClass, PointClass) {
        ...
        if (composedClasses.indexOf(ChartClass) === -1) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(ChartClass.prototype, {
...
// Add default options
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, defaultOptions, Sonification_Options);
/* *
 *
 *  Default Export
 *
