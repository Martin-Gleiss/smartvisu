...
var StandaloneNavigator = /** @class */ (function () {
    ...
    function StandaloneNavigator(element, userOptions) {
        ...
        var chart = new (highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default())(element,
            this.chartOptions);
        chart.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.options, { navigator: { enabled: true }, scrollbar: { enabled: true } });
    ...
    StandaloneNavigator.prototype.bind = function (axisOrChart, twoWay) {
        ...
        if (twoWay) {
            var removeSetExtremesEvent = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(axis, 'setExtremes',
                function (e) {
                    if (e.trigger === 'pan' ||
                        e.trigger === 'zoom' ||
    ...
    StandaloneNavigator.prototype.setRange = function (min, max, redraw, animation, eventArguments) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(this.navigator, 'setRange', {
            min: min,
            max: max,
            redraw: redraw,
            animation: animation,
            eventArguments: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(eventArguments, { trigger: 'navigator' })
        });
    };
    /**
