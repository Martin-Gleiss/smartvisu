...
})(typeof window === 'undefined' ? this : window, function(__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__956__, __WEBPACK_EXTERNAL_MODULE__448__, __WEBPACK_EXTERNAL_MODULE__820__, __WEBPACK_EXTERNAL_MODULE__512__) {
...
(function (OnSeriesComposition) {
    ...
    function compose(SeriesClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'OnSeries')) {
...
var WindbarbPoint = /** @class */ (function (_super) {
    ...
    WindbarbPoint.prototype.isValid = function () {
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(this.value) && this.value >= 0;
    };
...
var WindbarbSeries = /** @class */ (function (_super) {
     ...
     *
     * */
    WindbarbSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ColumnSeries.defaultOptions, Windbarb_WindbarbSeriesDefaults);
    return WindbarbSeries;
}(ColumnSeries));
Series_OnSeriesComposition.compose(WindbarbSeries);
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(WindbarbSeries.prototype, {
    beaufortFloor: [
