...
var SankeyPoint = /** @class */ (function (_super) {
    ...
    SankeyPoint.prototype.applyOptions = function (options, x) {
        ...
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.options.level)) {
    ...
    SankeyPoint.prototype.setNodeColumn = function () {
        var node = this;
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(node.options.column)) {
...
var SankeySeries = /** @class */ (function (_super) {
     ...
     * @private
     */
    SankeySeries.prototype.order = function (node, level, visited) {
        var series = this;
     ...
     * @internal
     */
    SankeySeries.prototype.getY = function (point, node, fromOrTo, linkHeight) {
        var linkTop = (node.offset(point,
            fromOrTo) || 0) * this.translationFactor;
    ...
    SankeySeries.prototype.translateLink = function (point, linkToY) {
        ...
        var linkHeight = Math.max((point.weight || 0) * translationFactor, this.options.minLinkWidth || 0), fromY = this.getY(point, fromNode, 'linksFrom', linkHeight), toY = linkToY || this.getY(point, toNode, 'linksTo', linkHeight), nodeW = this.nodeWidth, straight = right > nodeLeft + nodeW;
        if (chart.inverted) {
    ...
    SankeySeries.prototype.translateNode = function (node, column) {
        var translationFactor = this.translationFactor,
            ...
            borderWidth),
            left = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(this.colDistance * node.column +
                borderWidth / 2,
            borderWidth) + (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(node.options[chart.inverted ?
                'offsetVertical' :
                'offsetHorizontal'] || 0,
            nodeWidth),
