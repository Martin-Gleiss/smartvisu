...
function getFreeIndexes(numberOfColumns, seriesBuilders) {
    ...
    var freeIndexes = new Array(numberOfColumns).fill(true),
        freeIndexValues = [];
    // Loop all defined builders and remove their referenced columns
    seriesBuilders.forEach(function (seriesBuilder) {
        seriesBuilder.getReferencedColumnIndexes().forEach(function (index) {
            freeIndexes[index] = false;
        });
    });
    // Collect the values for the free indexes
    freeIndexes.forEach(function (isFree, i) {
        if (isFree) {
...
var Data = /** @class */ (function () {
    ...
    Data.prototype.init = function (dataOptions, chartOptions, chart) {
        ...
        this.columns = (dataOptions.columns ||
            ...
            []);
        this.firstRowAsNames = (_b = (_a = dataOptions.firstRowAsNames) !== null && _a !== void 0 ? _a : this.firstRowAsNames) !== null && _b !== void 0 ? _b : true;
    ...
    Data.prototype.fetchLiveData = function () {
        var data = this,
            ...
            originalOptions = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options);
        ...
        function performFetch(initialFetch) {
            ...
            function request(url, done, tp) {
                if (!url ||
                    !/^(http|\/|\.\/|\.\.\/)/.test(url)) {
                    if (url) {
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)("Invalid URL: ".concat(url), false, chart);
                    }
                    return false;
                }
                if (initialFetch) {
                ...
                ajax({
                    ...
                    error: function (xhr, e) {
                        ...
                        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)("Request failed - ".concat(xhr.status, " \n") +
    ...
    Data.prototype.parseGoogleSpreadsheet = function () {
        ...
        var getRange = function () {
            ...
            var end = alphabet.charAt((_a = options.endColumn) !== null && _a !== void 0 ? _a : -1) || 'ZZ';
        ...
        var rawColumns = this.rawColumns,
            ...
            forceCategory = (isXColumn &&
                ((chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions.xAxis) &&
                    (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(chartOptions.xAxis)[0].type === 'category')) || columnType === 'string',
            columnHasName = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(column.name);
    ...
    Data.prototype.getDataTable = function () {
        return new Data_DataTableCore({
            columns: Object.values(this.columns || [])
                .reduce(function (dtColumns, dtColumn) {
                // To avoid shifting the original column, create a copy
                var column = dtColumn.slice(),
    ...
    Data.prototype.complete = function () {
        ...
        if (options.complete || options.afterComplete) {
            ...
            if (this.firstRowAsNames) {
                for (i = 0; i < columns.length; i++) {
                    ...
                    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(curCol.name)) {
                        curCol.name = ((_a = curCol.shift()) !== null && _a !== void 0 ? _a : '').toString();
                    }
                }
            }
            ...
            if (allSeriesBuilders.length > 0 &&
                ...
                typeCol = columns === null || columns === void 0 ? void 0 : columns[(_b = allSeriesBuilders[0].readers[0].columnIndex) !== null && _b !== void 0 ? _b : -1];
            ...
            for (seriesIndex = 0; seriesIndex < allSeriesBuilders.length; seriesIndex++) {
                ...
                series[seriesIndex] = {
                    ...
                    pointStart: data[0] && (builder.pointIsArray ?
                        (_c = data[0]) === null || _c === void 0 ? void 0 : _c[0] :
                        (_d = data[0]) === null || _d === void 0 ? void 0 : _d.x) || void 0
                };
                if (builder.name) {
            ...
            (_e = options.complete) === null || _e === void 0 ? void 0 : _e.call(options, chartOptions);
            // The afterComplete hook is used internally to avoid conflict with
            // the externally available complete option.
            (_f = options.afterComplete) === null || _f === void 0 ? void 0 : _f.call(options, this, chartOptions);
        }
    };
    /**
        ...
        if (options) {
            ...
            options.afterComplete = function (dataInstance, dataChartOptions) {
                ...
                if (xAxisOptions && xAxis && ((xAxis.type !== xAxisOptions.type && !xAxis.options.type) ||
                    ...
                    ((dataChartOptions === null || dataChartOptions === void 0 ? void 0 : dataChartOptions.series) || []).forEach(function (seriesOptions) {
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)((highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default()), 'init', function (e) {
    var chart = this,
        callback = e.args[1],
        defaultDataOptions = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getOptions)().data;
    ...
    if ((defaultDataOptions || userOptions && userOptions.data) &&
         ...
         */
        var dataOptions = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultDataOptions,
            userOptions.data);
                ...
                if (Object.hasOwnProperty.call(userOptions, 'series')) {
                    if (typeof userOptions.series === 'object') {
                        ...
                        while (i--) {
                            ...
                            userOptions.series[i] = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(series, (_d = (_c = dataOptions === null || dataOptions === void 0 ? void 0 : dataOptions.series) === null || _c === void 0 ? void 0 : _c[i]) !== null && _d !== void 0 ? _d : {});
                        }
                    }
...
var SeriesBuilder = /** @class */ (function () {
    ...
    SeriesBuilder.prototype.read = function (columns, rowIndex) {
        ...
        if (typeof this.name === 'undefined' && builder.readers.length >= 2) {
            ...
            this.name = columns[(_a = columnIndexes_1.shift()) !== null && _a !== void 0 ? _a : 0].name;
        }
        return point;
    };
    /**
