...
(function (ControlTarget) {
    ...
    function linkPoints() {
        var pointsOptions = this.getPointsOptions(),
            points = this.points,
            len = (pointsOptions === null || pointsOptions === void 0 ? void 0 : pointsOptions.length) || 0;
        var i,
            point;
        for (i = 0; i < len; i++) {
    ...
    function point(pointOptions, point) {
        ...
        if (!point || point.series === null) {
            if (isObject(pointOptions)) {
                ...
                var pointConfigOrPoint = pointOptions.call(point,
                    this);
...
var Controllable = /** @class */ (function () {
    ...
    Controllable.prototype.calculateAnnotationSize = function (startPoint, value, axis) {
        var startPixel = axis.toPixels(startPoint,
            true),
            endPixel = axis.toPixels(startPoint + value,
            true);
...
var ControllableCircle = /** @class */ (function (_super) {
     ...
     *
     * */
    ControllableCircle.prototype.init = function (annotation, options, index) {
        var point = options.point,
            xAxis = options.xAxis,
            yAxis = options.yAxis;
        if (point && typeof point !== 'string') {
...
function getFields(parentDiv, type) {
    ...
    inputList.forEach(function (input) {
        ...
        if (seriesId) {
            ...
            if (opacityInput) {
                var rgba = highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default().parse(input.value).rgba;
...
function resolveColorValue(value, contextElement) {
    ...
    var rgbaToHex = function (value) {
            var _a = highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default().parse(value).rgba,
        r = _a[0],
        g = _a[1],
        b = _a[2],
        a = _a[3];
    ...
    if (value.startsWith('color') || value.startsWith('var')) {
        ...
        var dummy = Popup_doc.createElement('span');
        ...
        if (computed.startsWith('color')) {
            var srgbMatch = computed.match(new RegExp('color\\s*\\(\\s*srgb\\s+([\\d.]+)\\s+([\\d.]+)\\s+' +
                    '([\\d.]+)\\s+(?:\\s*\\/\\s*([\\d.]+))?\\s*\\)'));
            if (srgbMatch) {
                var r = Math.round(parseFloat(srgbMatch[1]) * 255),
...
var Popup = /** @class */ (function (_super) {
    ...
    Popup.prototype.createColorInput = function (option, inputName, inputAttributes, parentDiv, container) {
        var _a = resolveColorValue(inputAttributes.value || '',
            container),
            value = _a.value,
            alpha = _a.alpha;
...
var Annotation = /** @class */ (function (_super) {
    ...
    Annotation.prototype.initShape = function (shapeOptions, index) {
        var options = merge(this.options.shapeOptions, {
            ...
            shapeOptions),
            shape = new Annotation.shapesMap[options.type || 'rect'](this,
            options,
            index);
...
if ((_a = CrookedLine_defaultOptions.annotations) === null || _a === void 0 ? void 0 : _a.types) {
    /**
...
if ((InfinityLine_a = InfinityLine_defaultOptions.annotations) === null || InfinityLine_a === void 0 ? void 0 : InfinityLine_a.types) {
    /**
...
if ((VerticalLine_a = VerticalLine_defaultOptions.annotations) === null || VerticalLine_a === void 0 ? void 0 : VerticalLine_a.types) {
    /**
...
var VerticalLine = /** @class */ (function (_super) {
    ...
    VerticalLine.prototype.addLabels = function () {
        var typeOptions = this.options.typeOptions,
            ...
            offset = (labelOptions === null || labelOptions === void 0 ? void 0 : labelOptions.offset) || 0;
...
var Measure = /** @class */ (function (_super) {
    ...
    Measure.prototype.addValues = function (resize) {
        ...
        if (this.labels.length > 0) {
            (this.labels[0]).text = ((formatter === null || formatter === void 0 ? void 0 : formatter.call(this, this)) ||
