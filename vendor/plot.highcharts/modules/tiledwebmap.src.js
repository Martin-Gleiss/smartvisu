...
function onRecommendMapView(e) {
    ...
    if (twm && twm.provider && twm.provider.type && !twm.provider.url) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(ProviderDefinition)) {
...
var TiledWebMapSeries = /** @class */ (function (_super) {
    ...
    TiledWebMapSeries.prototype.drawPoints = function () {
        ...
        if (provider && (provider.type || provider.url)) {
            if (provider.type && !provider.url) {
                ...
                var theme = void 0,
                    subdomain = '';
                if (provider.theme && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(def.themes[provider.theme])) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.minZoom) && zoomFloor < this.minZoom) {
            ...
            else if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.maxZoom) && zoomFloor > this.maxZoom) {
            ...
            var _loop_1 = function (zoomKey) {
                    var _loop_3 = function (key) {
                        ...
                        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(posX_1) &&
                            ...
                            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(firstTile.posY)) {
    ...
    TiledWebMapSeries.prototype.update = function (options) {
        ...
        if (mapView &&
            !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)((_a = chart.userOptions.mapView) === null || _a === void 0 ? void 0 : _a.projection) &&
