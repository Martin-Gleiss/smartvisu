...
var ParallelAxis_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
            ...
            axis.series.forEach(function (series) {
                if (series.visible && isNumber(index_1)) {
                    currentPoints_1 = (series.pointArrayMap || ['y'])
                        ...
                        var _a,
                            _b;
                        return ParallelAxis_spreadArray(ParallelAxis_spreadArray([], currentPoints, true), [
...
(function (ParallelCoordinates) {
    ...
    function compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass) {
        ...
        if (!chartProto.setParallelInfo) {
            ...
            merge(true, highchartsDefaultOptions.chart, ParallelCoordinates_ParallelCoordinatesDefaults.chart);
        }
    }
    ...
    function onChartInit(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            options.xAxis = merge(ParallelCoordinates_ParallelCoordinatesDefaults.xAxis, // Docs
