...
(function (ParallelAxis) {
    ...
    function onAfterSetOptions(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            if (axis.isXAxis) {
                axis.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(axis.options, ParallelCoordinates_ParallelCoordinatesDefaults.xAxis, e.userOptions);
            }
            else {
    ...
    function onGetSeriesExtremes(e) {
        ...
        if (chart && chart.hasParallelCoordinates && !axis.isXAxis) {
            ...
            axis.series.forEach(function (series) {
                if (series.visible && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(index_1)) {
            ...
            currentPoints_1 = currentPoints_1.filter(highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber);
            axis.dataMin = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMin)(currentPoints_1);
            axis.dataMax = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(currentPoints_1);
            e.preventDefault();
        }
    }
    /**
...
(function (ParallelSeries) {
    ...
    function compose(SeriesClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'ParallelSeries')) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(CompoClass, 'destroy', onSeriesDestroy);
    ...
    function onSeriesAfterTranslate() {
        ...
        if (this.chart.hasParallelCoordinates) {
            for (var i = 0; i < dataLength; i++) {
                point = points[i];
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(point.y)) {
                    if (chart.polar) {
                    ...
                    // Range series (#15752)
                    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(point.high)) {
    ...
    function onSeriesBindAxes(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            for (var _i = 0, _a = chart.axes; _i < _a.length; _i++) {
                var axis = _a[_i];
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.insertItem)(series_1, axis.series);
                axis.isDirty = true;
            }
    ...
    function onSeriesDestroy() {
        ...
        if (chart.hasParallelCoordinates) {
            for (var _i = 0, _a = (chart.axes || []); _i < _a.length; _i++) {
                var axis = _a[_i];
                if (axis && axis.series) {
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.erase)(axis.series, series);
    ...
    function onSeriesAfterGeneratePoints() {
        ...
        if (chart === null || chart === void 0 ? void 0 : chart.hasParallelCoordinates) {
            for (var _i = 0, _g = this.points; _i < _g.length; _i++) {
                ...
                if (labelFormat) {
                    formattedValue = format(labelFormat, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(point, { value: point.y }), chart);
                }
                ...
                else if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(yAxisOptions.categories)) {
...
(function (ParallelCoordinates) {
    ...
    function compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass) {
        ...
        if (!chartProto.setParallelInfo) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartCompo, 'init', onChartInit);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartCompo, 'update', onChartUpdate);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, highchartsDefaultOptions.chart, ParallelCoordinates_ParallelCoordinatesDefaults.chart);
        }
    }
    ...
    function onChartInit(e) {
        var chart = this,
            options = e.args[0],
            defaultYAxis = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.yAxis || {}),
            newYAxes = [];
        ...
        if (chart.hasParallelCoordinates) {
            ...
            options.xAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ParallelCoordinates_ParallelCoordinatesDefaults.xAxis, // Docs
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.xAxis || {})[0]);
        }
    }
    /**
     * Initialize parallelCoordinates
    ...
    function onChartUpdate(e) {
        ...
        if (options.chart) {
            ...
            chart.options.chart.parallelAxes = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.options.chart.parallelAxes, options.chart.parallelAxes);
        }
        if (chart.hasParallelCoordinates) {
            // (#10081)
            if (options.series) {
