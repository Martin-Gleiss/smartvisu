...
function compose(AxisClass, TickClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'Variwide')) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(tickProto, 'getLabelPosition', wrapTickGetLabelPosition);
    }
}
/**
...
var VariwideSeries = /** @class */ (function (_super) {
    ...
    VariwideSeries.prototype.getXExtremes = function (xData) {
        var max = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(xData),
            maxZ = this.getColumn('z')[xData.indexOf(max)];
        return {
            min: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMin)(xData),
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(VariwideSeries, 'afterColumnTranslate', function () {
    ...
    for (var _i = 0, _a = this.points; _i < _a.length; _i++) {
        ...
        if (this.crispOption) {
            left = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(left, this.borderWidth);
            right = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(right, this.borderWidth);
        }
        shapeArgs.x = left;
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(VariwideSeries.prototype, {
