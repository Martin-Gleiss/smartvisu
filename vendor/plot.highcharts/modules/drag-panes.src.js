...
var AxisResizer = /** @class */ (function () {
    ...
    AxisResizer.prototype.render = function () {
        var resizer = this,
            ...
            pos = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(axis.top + axis.height + y,
            chart.plotTop,
    ...
    AxisResizer.prototype.addMouseEvents = function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(container, 'mousemove', mouseMoveHandler), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(container.ownerDocument, 'mouseup', mouseUpHandler), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ctrlLineElem, 'mousedown', mouseDownHandler), 
        // Touch events.
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(container, 'touchmove', mouseMoveHandler), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(container.ownerDocument, 'touchend', mouseUpHandler), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ctrlLineElem, 'touchstart', mouseDownHandler));
    ...
    AxisResizer.prototype.updateAxes = function (chartY) {
        var resizer = this,
            ...
            min,
            max) { return (Math.round((0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(val,
            min,
            max))); };
        // Normalize chartY to plot area limits
        chartY = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(chartY, plotTop, plotBottom);
        var stopDrag = false,
        ...
        for (var _i = 0, _a = [prevAxes, nextAxes]; _i < _a.length; _i++) {
            ...
            for (var _b = 0, axesGroup_1 = axesGroup; _b < axesGroup_1.length; _b++) {
                ...
                var axis = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(axisInfo) ?
                ...
                top_1 = axis.top;
                var minLength = Math.round((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(axisOptions.minLength || NaN,
                    plotHeight)),
                    maxLength = Math.round((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(axisOptions.maxLength || NaN,
                    plotHeight));
...
function compose(AxisClass, PointerClass) {
    if (!AxisClass.keepProps.includes('resizer')) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(PointerClass.prototype, 'drag', wrapPointerDrag);
    }
}
/**
