...
function composePriceIndication(SeriesClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'PriceIndication')) {
...
function onSeriesAfterRender() {
    ...
    if ((lastVisiblePrice || lastPrice) &&
        ...
        if ((lastVisiblePrice === null || lastVisiblePrice === void 0 ? void 0 : lastVisiblePrice.enabled) && pLength > 0) {
            yAxis.crosshair = yAxis.options.crosshair = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
