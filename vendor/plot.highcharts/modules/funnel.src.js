    ...
    FunnelSeries.prototype.translate = function () {
        ...
        series.getXPos = function (y, half, point) {
            ...
            return centerX + (half ? -1 : 1) *
                ((series.getWidthAt(reversed ? 2 * centerY - y : y) / 2) +
                    ((_c = (_b = (_a = point.dataLabel) === null || _a === void 0 ? void 0 : _a.dataLabelPosition) === null || _b === void 0 ? void 0 : _b.distance) !== null && _c !== void 0 ? _c : (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(((_d = this.options.dataLabels) === null || _d === void 0 ? void 0 : _d.distance) || 0, width)));
        };
        // Expose
        ...
        */
        ...
        for (var _a = 0, points_2 = points; _a < points_2.length; _a++) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(y1) >= neckY) {
...
var PyramidSeries = /** @class */ (function (_super) {
     ...
     */
    PyramidSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(Funnel_FunnelSeries.defaultOptions, Pyramid_PyramidSeriesDefaults);
