...
var Fullscreen = /** @class */ (function () {
    ...
    Fullscreen.compose = function (ChartClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'Fullscreen')) {
    ...
    Fullscreen.prototype.close = function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'fullscreenClose', void 0, function () {
    ...
    Fullscreen.prototype.open = function () {
        var fullscreen = this,
            chart = fullscreen.chart,
            optionsChart = chart.options.chart;
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'fullscreenOpen', void 0, function () {
            if (optionsChart) {
            ...
            if (fullscreen.browserProps) {
                var unbindChange_1 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart.container.ownerDocument, // Chart's document
                ...
                var unbindDestroy_1 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart, 'destroy',
                    unbindChange_1);
        ...
        if ((exportingOptions === null || exportingOptions === void 0 ? void 0 : exportingOptions.menuItemDefinitions) &&
            ...
            if (exportDivElement) {
                highcharts_AST_commonjs_highcharts_AST_commonjs2_highcharts_AST_root_Highcharts_AST_default().setElementHTML(exportDivElement, !this.isOpen ?
                    (((_b = exportingOptions.menuItemDefinitions.viewFullscreen) === null || _b === void 0 ? void 0 : _b.text) ||
...
var Exporting = /** @class */ (function () {
        ...
        return Exporting_awaiter(this, void 0, void 0, function () {
            ...
            return Exporting_generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a = _b.sent();
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)("Warning: Failed to fetch CSS from ".concat(href), false);
                        return [3 /*break*/, 4];
    ...
    Exporting.prototype.addButton = function (options) {
        ...
        var exporting = this,
            ...
            btnOptions = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)((_a = chart.options.navigation) === null || _a === void 0 ? void 0 : _a.buttonOptions,
            options),
    ...
    Exporting.prototype.afterPrint = function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'afterPrint');
    };
    /**
    ...
    Exporting.prototype.beforePrint = function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(chart, 'beforePrint');
    ...
    Exporting.prototype.contextMenu = function (className, items, x, y, width, height, button) {
        ...
        if (!menu) {
            ...
            innerMenu = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('ul', { className: 'highcharts-menu' }, chart.styledMode ? {} : {
                listStyle: 'none',
                margin: 0,
                padding: 0
            }, menu);
            // Presentational CSS
            if (!chart.styledMode) {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(innerMenu, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({
            ...
            (_b = exporting.events) === null || _b === void 0 ? void 0 : _b.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(menu, 'mouseleave', function () {
                menu.hideTimer = Exporting_win.setTimeout(menu.hideMenu, 500);
            }), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(menu, 'mouseenter', function () {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.internalClearTimeout)(menu.hideTimer);
            }), 
            // Hide it on clicking or touching outside the menu (#2258,
            // #2335, #2407)
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(Exporting_doc, 'mouseup', function (e) {
                var _a;
                if (!((_a = chart.pointer) === null || _a === void 0 ? void 0 : _a.inClass(e.target, className))) {
                    menu.hideMenu();
                }
            }), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(menu, 'click', function () {
                var _a;
            ...
            items.forEach(function (item) {
                ...
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(item, true)) {
                    var element = void 0;
                    if (item.separator) {
                        element = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('li', {
                        ...
                        if (!chart.styledMode) {
                            element.onmouseover = function () {
                                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(this, (navOptions === null || navOptions === void 0 ? void 0 : navOptions.menuItemHoverStyle) || {});
                            };
                            element.onmouseout = function () {
                                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(this, (navOptions === null || navOptions === void 0 ? void 0 : navOptions.menuItemStyle) || {});
                            };
                            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(element, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ cursor: 'pointer' }, (navOptions === null || navOptions === void 0 ? void 0 : navOptions.menuItemStyle) || {}));
                        }
                    }
    ...
    Exporting.prototype.destroy = function (e) {
        ...
        divElements.forEach(function (elem, i) {
            if (elem) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.internalClearTimeout)(elem.hideTimer); // #5427
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.removeEvent)(elem, 'mouseleave');
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.discardElement)(elem);
            }
        });
            ...
            return Exporting_generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(Exporting.prototype, 'downloadSVG', eventArgs);
        ...
        return Exporting_awaiter(this, void 0, void 0, function () {
            ...
            return Exporting_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Merge the options
                        exportingOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options, exportingOptions);
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (exportingOptions.error) {
                            ...
                            // Fallback disabled
                            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)((err === null || err === void 0 ? void 0 : err.message) || 28, true, this.chart);
                        }
                        return [3 /*break*/, 4];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 4];
                    case 3:
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)(err.message, false);
                        _a.label = 4;
                    case 4: return [2 /*return*/];
                }
            });
    ...
    Exporting.prototype.getChartHTML = function (applyStyleSheets) {
        ...
        chart.container.querySelectorAll('canvas').forEach(function (canvas) {
            var imageDataURL = canvas.toDataURL('image/png'),
                ...
                imageElem = chart.renderer.image(imageDataURL, 0, 0,
                canvas.width,
                canvas.height);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(imageElem.element, {
    ...
    Exporting.prototype.getSVG = function (chartOptions, async) {
        ...
        var svg,
            ...
            options = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.options,
            chartOptions);
        // Use userOptions to make the options chain in series right (#3881)
        options.plotOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.userOptions.plotOptions, chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions.plotOptions);
        // ... and likewise with time, avoid that undefined time properties are
        // merged over legacy global time options
        options.time = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.userOptions.time, chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions.time);
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(options.chart, {
            animation: false,
            renderTo: sandbox,
            forExport: true,
        ...
        chart.series.forEach(function (s) {
            var _a;
            seriesOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(s.userOptions, {
        ...
        chart.axes.forEach(function (axis) {
            ...
            if (!axis.userOptions.internalKey) { // #6444
                axis.userOptions.internalKey = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.uniqueKey)();
            }
            if (options && !axis.options.isInternal) {
                ...
                options[axis.coll].push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(axis.userOptions, {
        ...
        var postprocessAndGetSVG = function (chartCopy) {
            ...
            chart.axes.forEach(function (axis) {
                var axisCopy = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(chartCopy.axes,
                    function (copy) {
                ...
                if (axisCopy) {
                    var extremes = axis.getExtremes(), 
                        ...
                        exportOverride = (0,
                        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)((chartOptions === null || chartOptions === void 0 ? void 0 : chartOptions[axis.coll]) || {})[0],
            ...
            options = void 0;
            chartCopy.destroy();
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.discardElement)(sandbox);
            return svg;
        };
        ...
        return new Promise(function (resolve) {
            return new chart.constructor(options || {}, function (e) {
                ...
                // chart copy (#24537)
                var unbindRender = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this, 'render',
                    function () {
                        unbindRender();
            ...
            return Exporting_generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getSVG((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ chart: { borderRadius: 0 } }, currentExportingOptions.chartOptions, chartOptions, {
                                exporting: {
    ...
    Exporting.prototype.inlineStyles = function () {
        ...
        // this body
        var iframe = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('iframe',
            void 0, {
                width: '1px',
                height: '1px',
                visibility: 'hidden'
        ...
        return Exporting_awaiter(this, void 0, void 0, function () {
            ...
            return Exporting_generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    return [4 /*yield*/, exporting.downloadSVG(sanitizedSVG, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ filename: exporting.getFilename() }, exportingOptions))];
                    case 13:
                        // Trigger SVG download
                        _d.sent();
                        _d.label = 14;
    ...
    Exporting.prototype.render = function () {
        ...
        if (isDirty && options.enabled !== false) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(options === null || options === void 0 ? void 0 : options.buttons, function (button) {
...
(function (Exporting) {
    ...
    function compose(ChartClass, SVGRendererClass) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(Exporting_composed, 'Exporting')) {
            return;
        }
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'layOutTitle', onChartLayOutTitle);
        if (Exporting_isSafari) {
    ...
    function onChartLayOutTitle(_a) {
        ...
        var exportingOptions = this.options.exporting,
            _f = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)((_b = this.options.navigation) === null || _b === void 0 ? void 0 : _b.buttonOptions, (_c = exportingOptions === null || exportingOptions === void 0 ? void 0 : exportingOptions.buttons) === null || _c === void 0 ? void 0 : _c.contextButton),
            align = _f.align,
            _g = _f.buttonSpacing,
