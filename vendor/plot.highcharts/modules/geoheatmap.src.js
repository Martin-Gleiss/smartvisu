...
var GeoHeatmapSeries = /** @class */ (function (_super) {
    ...
    GeoHeatmapSeries.prototype.update = function () {
        var series = this;
        series.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(series.options, arguments[0]);
    ...
    GeoHeatmapSeries.prototype.getInterpolation = function () {
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(this.options.interpolation)) {
            return {
                blur: 1,
            ...
            if (canvas && ctx && colorAxis && topLeft && bottomRight) {
                ...
                if (image_1) {
                    if (chart_1.renderer.globalAnimation && chart_1.hasRendered) {
                        ...
                        image_1
                            .attr((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ animator: 0 }, series.isDirtyCanvas ? {
     ...
     */
    GeoHeatmapSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(MapSeries.defaultOptions, {
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(GeoHeatmapSeries, 'afterDataClassLegendClick', function () {
    this.isDirtyCanvas = true;
    this.drawPoints();
});
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(GeoHeatmapSeries.prototype, {
    type: 'geoheatmap',
    applyJitter: noop,
