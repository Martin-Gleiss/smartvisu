...
(function (CircleUtilities) {
    ...
    function getAreaOfCircle(r) {
        ...
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(Math.PI * r * r);
    }
...
function addOverlapToSets(relations) {
    ...
    relations
        ...
        relation.sets.forEach(function (set, i, arr) {
            var _a;
            if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(mapOfIdToProps[set])) {
                mapOfIdToProps[set] = {
                    totalOverlap: 0,
                    overlapping: {}
                };
    ...
    relations
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(set, properties);
    });
 ...
 */
function isSet(x) {
    return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(x.sets) && x.sets.length === 1;
}
// eslint-disable-next-line require-jsdoc
/**
 *
...
function isValidRelation(x) {
    var map = {};
    return ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(x) &&
        ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(x.value) && x.value > -1) &&
        ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(x.sets) && x.sets.length > 0) &&
        !x.sets.some(function (set) {
            var invalid = false;
            if (!map[set] && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(set)) {
                map[set] = true;
            }
            else {
                invalid = true;
...
function processVennData(dataTable, splitter) {
    var rows = (dataTable === null || dataTable === void 0 ? void 0 : dataTable.columns) ?
    ...
    var validSets = rows
        ...
        .sort();
    var mapOfIdToRelation = rows.reduce(function (mapOfIdToRelation,
        relation) {
            if (relation.sets &&
...
var VennSeries = /** @class */ (function (_super) {
    ...
    VennSeries.updateFieldBoundaries = function (field, circle) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.left) || field.left > left) {
            field.left = left;
        }
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.right) || field.right < right) {
            field.right = right;
        }
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.top) || field.top > top) {
            field.top = top;
        }
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.bottom) || field.bottom < bottom) {
            field.bottom = bottom;
        }
        return field;
    };
    ...
    VennSeries.prototype.drawPoints = function () {
        ...
        for (var _i = 0, points_1 = points; _i < points_1.length; _i++) {
            ...
            var attribs = {
                    zIndex: (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(point.sets) ? point.sets.length : 0
                },
                shapeArgs = point.shapeArgs;
            // Add point attribs
            if (!chart.styledMode) {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(attribs, series.pointAttribs(point, point.state));
            }
    ...
    VennSeries.prototype.translate = function () {
        ...
        var relations = Venn_VennUtils.processVennData(this.dataTable,
            VennSeries.splitter);
        ...
        var field = Object.keys(mapOfIdToShape)
            ...
            return shape && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(shape.r);
        })
        ...
        for (var _i = 0, _c = this.points; _i < _c.length; _i++) {
            var point = _c[_i];
            var sets = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(point.sets) ? point.sets : [],
                id = sets.join(),
            ...
            if (shape) {
                ...
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(dataLabelWidth)) {
            ...
            if (dataLabelWidth && shapeArgs) {
                point.dlOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ style: { width: dataLabelWidth } }, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(dlOptions, true) ? dlOptions : void 0, { zIndex: void 0 });
