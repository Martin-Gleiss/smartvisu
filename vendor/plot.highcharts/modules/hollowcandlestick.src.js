...
})(typeof window === 'undefined' ? this : window, function(__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__512__, __WEBPACK_EXTERNAL_MODULE__532__) {
...
var HollowCandlestickSeries = /** @class */ (function (_super) {
    ...
    HollowCandlestickSeries.prototype.getPriceMovement = function () {
        ...
        for (var i = 0; i < dataLength; i++) {
            var dataPoint = table.getRowObject(i,
                this.pointArrayMap);
    ...
    HollowCandlestickSeries.prototype.isBullish = function (dataPoint, previousDataPoint) {
        return {
            ...
            // For bearish candles.
            trendDirection: (dataPoint.close || 0) < ((previousDataPoint === null || previousDataPoint === void 0 ? void 0 : previousDataPoint.close) || 0) ?
                'down' : 'up'
        };
    };
    /**
    ...
    HollowCandlestickSeries.prototype.pointAttribs = function (point, state) {
        var attribs = _super.prototype.pointAttribs.call(this,
            ...
            state);
        var stateOptions;
        var index = point === null || point === void 0 ? void 0 : point.index,
     ...
     */
    HollowCandlestickSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(HollowCandlestickSeries_CandlestickSeries.defaultOptions, {
        /**
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(HollowCandlestickSeries, 'updatedData', function () {
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)((highcharts_Axis_commonjs_highcharts_Axis_commonjs2_highcharts_Axis_root_Highcharts_Axis_default()), 'postProcessData', function () {
    var axis = this,
        series = axis.series;
