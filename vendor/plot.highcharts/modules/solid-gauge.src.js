...
/** @internal */
function init(axis) {
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(axis, Color_ColorAxisBase);
}
/* *
 *
 *  Default export
...
var SolidGaugeSeries = /** @class */ (function (_super) {
    ...
    SolidGaugeSeries.prototype.drawPoints = function () {
        ...
        for (var _i = 0, _h = series.points; _i < _h.length; _i++) {
            ...
            if (!point.isNull) { // Condition like in pie chart
                var paneInnerSize = yAxis.pane.options.innerSize,
                    radius = (((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)((_c = (_b = point.options.radius) !== null && _b !== void 0 ? _b : options.radius) !== null && _c !== void 0 ? _c : '100%',
                    center[2] / 2))),
                    innerRadius = Math.min(((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)((_f = (_e = (_d = point.options.innerRadius) !== null && _d !== void 0 ? _d : options.innerRadius) !== null && _e !== void 0 ? _e : ((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(paneInnerSize) ?
                        paneInnerSize / 2 :
                        paneInnerSize)) !== null && _f !== void 0 ? _f : 0,
                    center[2] / 2)),
                    radius),
                ...
                rotation = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(rotation, axisMinAngle - overshootVal, axisMaxAngle + overshootVal);
                // Handle the wrap option
                if (options.wrap === false) {
                    rotation = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(rotation, axisMinAngle, axisMaxAngle);
                }
                ...
                if (graphic) {
                    d = shapeArgs.d;
                    graphic.animate((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(attribs, shapeArgs));
                    if (d) {
     ...
     *
     * */
    SolidGaugeSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(GaugeSeries.defaultOptions, SolidGauge_SolidGaugeSeriesDefaults);
