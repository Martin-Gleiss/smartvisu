    ...
    BulletSeries.prototype.drawPoints = function () {
        ...
        for (var _i = 0, _a = series.points; _i < _a.length; _i++) {
            ...
            var targetShapeArgs = void 0,
                ...
                y = void 0;
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(targetVal) && targetVal !== null) {
                targetOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.targetOptions, pointOptions.targetOptions);
                height = targetOptions.height;
                var shapeArgs = point.shapeArgs;
                // #15547
                if (point.dlBox && shapeArgs && !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(shapeArgs.width)) {
                    shapeArgs = point.dlBox;
                }
                width = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(targetOptions.width, shapeArgs.width);
                ...
                if (targetGraphic) {
                    ...
                    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(pointVal) && pointVal !== null) {
