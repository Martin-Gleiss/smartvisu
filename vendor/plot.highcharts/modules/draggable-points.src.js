...
function addEvents(el, types, fn, options) {
    var removeFuncs = types.map(function (type) { return (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(el,
        type,
        fn,
        options); });
    return function () {
...
function addDragDropEvents(chart) {
    ...
    if (isChartDraggable(chart)) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(container, 'mouseleave', function (e) {
...
function chartSetGuideBoxState(state, options) {
    var guideBox = this.dragGuideBox,
        guideBoxOptions = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(DraggablePoints_DragDropDefaults.guideBox,
        options),
        stateOptions = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(guideBoxOptions['default'], // eslint-disable-line dot-notation
...
function dragMove(e, point) {
    ...
    var series = point.series,
        ...
        options = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(series.options.dragDrop,
    ...
    // update the guideBox.
    if ((_a = options.liveRedraw) !== null && _a !== void 0 ? _a : true) {
...
function getGroupedPoints(point) {
    ...
    var points = [];
    if (series.boosted && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(data)) { // #11156
...
function initDragDrop(e, point) {
    ...
    if (!((_b = (_a = series.options.dragDrop) === null || _a === void 0 ? void 0 : _a.liveRedraw) !== null && _b !== void 0 ? _b : true)) {
        chart.dragGuideBox = guideBox = series.getGuideBox(groupedPoints);
        chart
            .setGuideBoxState('default', (_c = series.options.dragDrop) === null || _c === void 0 ? void 0 : _c.guideBox)
            .add(series.group);
    }
...
function mouseDown(e, chart) {
    var dragPoint = chart.hoverPoint,
        dragDropOptions = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(dragPoint && dragPoint.series.options.dragDrop,
...
function mouseMove(e, chart) {
    ...
    if (dragDropData && dragDropData.isDragging && dragDropData.point.series) {
        ...
        if (!dragDropData.draggedPastSensitivity) {
            dragDropData.draggedPastSensitivity = hasDraggedPastSensitivity(e, chart, (_d = (_c = (_b = (_a = point.options.dragDrop) === null || _a === void 0 ? void 0 : _a.dragSensitivity) !== null && _b !== void 0 ? _b : seriesDragDropOpts === null || seriesDragDropOpts === void 0 ? void 0 : seriesDragDropOpts.dragSensitivity) !== null && _c !== void 0 ? _c : DraggablePoints_DragDropDefaults.dragSensitivity) !== null && _d !== void 0 ? _d : 2);
        }
...
var waterfall = {
    x: column.x,
    y: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(column.y, {
        handleFormatter: function (point) {
            var _a,
                _b;
...
var gantt = {
     ...
     */
    start: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(xrange.x, {
     ...
     */
    end: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(xrange.x2, {
...
function DraggablePoints_compose(ChartClass, SeriesClass) {
    ...
    if (!seriesProto.dragDropProps) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(PointClass, 'mouseOut', onPointMouseOut);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(PointClass, 'mouseOver', onPointMouseOver);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(PointClass, 'remove', onPointRemove);
...
function pointGetDropValues(origin, newPos, updateProps) {
    ...
    var limitToRange = function (val,
        ...
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(res, min, max);
    };
    /**
     * Utility function to apply precision and limit a value within the
    ...
    for (var _i = 0, _a = Object.keys(updateProps); _i < _a.length; _i++) {
        ...
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(newVal) &&
            !(updateSingleProp &&
                val.propValidate &&
...
function pointShowDragHandles() {
    ...
    var _loop_1 = function (key) {
            var val = dragDropProps[key],
        handleOptions = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(DraggablePoints_DragDropDefaults.dragHandle,
        val.handleOptions,
        options.dragHandle),
        handleAttrs = {
        ...
        if (val.resize &&
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(dragHandles.group.element, 'mouseover', function () {
...
function seriesGetGuideBox(points) {
    ...
    for (var _i = 0, points_1 = points; _i < points_1.length; _i++) {
        ...
        if (bBox) {
            var plotX2 = void 0;
            var x2 = point.x2;
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(x2)) {
