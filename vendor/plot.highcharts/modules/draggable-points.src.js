...
var DraggableChart_doc = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).doc;
...
function addDragDropEvents(chart) {
    ...
    if (isChartDraggable(chart)) {
        ...
        chart.unbindDragDropMouseUp = DraggableChart_addEvents(DraggableChart_doc, ['mouseup', 'touchend'], function (e) {
            mouseUp(DraggableChart_getNormalizedEvent(e, chart), chart);
        }, {
            passive: false
        });
...
function pointShowDragHandles() {
    ...
    var _loop_1 = function (key) {
            var val = dragDropProps[key],
        handleOptions = merge(DraggablePoints_DragDropDefaults.dragHandle,
        val.handleOptions,
        options.dragHandle),
        handleAttrs = {
