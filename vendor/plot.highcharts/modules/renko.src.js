...
})(typeof window === 'undefined' ? this : window, function(__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__512__, __WEBPACK_EXTERNAL_MODULE__448__) {
...
var RenkoSeries = /** @class */ (function (_super) {
    ...
    RenkoSeries.prototype.getProcessedData = function () {
        ...
        var change = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(boxSize) ? boxSize : (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(boxSize,
            yData[0]);
        var renkoData = [],
            length = xData.length;
        var prevTrend = 0;
