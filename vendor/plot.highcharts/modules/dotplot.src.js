...
var DotPlotSeries = /** @class */ (function (_super) {
    ...
    DotPlotSeries.prototype.drawPoints = function () {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(slotsPerBar)) {
            slotsPerBar = 1;
            ...
            if (typeof point.y === 'number') {
                ...
                for (var val = 0; val < positiveYValue; val++) {
                    ...
                    if (graphic) {
                        ...
                        graphic = renderer
                            .symbol(symbol)
                            .attr((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(attr, pointAttr))
                            .add(point.graphic);
                    }
     ...
     *
     * */
    DotPlotSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ColumnSeries.defaultOptions, DotPlot_DotPlotSeriesDefaults);
    return DotPlotSeries;
}(ColumnSeries));
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(DotPlotSeries.prototype, {
