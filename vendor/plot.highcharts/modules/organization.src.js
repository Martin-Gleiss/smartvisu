...
var OrganizationPoint = /** @class */ (function (_super) {
    ...
    OrganizationPoint.prototype.setNodeColumn = function () {
        ...
        if (
        // Not defined by user
        !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(node.options.column) &&
            // Has links to
...
var OrganizationSeries = /** @class */ (function (_super) {
    ...
    OrganizationSeries.prototype.alignDataLabel = function (point, dataLabel, options) {
        ...
        if (options.useHTML && shapeArgs) {
            var padding = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(this.options.dataLabels.padding || 0),
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(text.element.parentNode, {
                width: width_1 + 'px',
                height: height_1 + 'px'
            });
            // Set properties for the span emulating `text`
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(text.element, {
                left: 0,
                top: 0,
                width: '100%',
                height: '100%',
    ...
    OrganizationSeries.prototype.pointAttribs = function (point, state) {
        ...
        if (!point.isNode) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(borderRadius)) {
    ...
    OrganizationSeries.prototype.translateLink = function (point) {
        ...
        if (fromNode.shapeArgs && toNode.shapeArgs) {
            ...
            xMiddle = this.colDistance ?
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(x2 +
                    ((inverted ? 1 : -1) *
                        (this.colDistance - this.nodeWidth)) /
                        2, linkWidth) :
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((x2 + x1) / 2, linkWidth);
            // Put the link on the side of the node when an offset is given. HR
            // node in the main demo.
            if (percentOffset &&
                (percentOffset >= 50 || percentOffset <= -50)) {
                xMiddle = x2 = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(x2 + (inverted ? -0.5 : 0.5) *
            ...
            if (toNode.hangsFrom === fromNode) {
                if (chart.inverted) {
                    y1 = !hangingRight ?
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((fromNode.shapeArgs.y || 0) +
                            (fromNode.shapeArgs.height || 0) -
                            hangingIndent / 2, linkWidth) :
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((fromNode.shapeArgs.y || 0) + hangingIndent / 2, linkWidth);
                    y2 = !hangingRight ? ((toNode.shapeArgs.y || 0) +
                        (toNode.shapeArgs.height || 0)) : (toNode.shapeArgs.y || 0) + hangingIndent / 2;
                }
                else {
                    y1 = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((fromNode.shapeArgs.y || 0) + hangingIndent / 2, linkWidth);
                }
                xMiddle = x2 = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((toNode.shapeArgs.x || 0) +
    ...
    OrganizationSeries.prototype.translateNode = function (node, column) {
        ...
        if (node.shapeArgs && !node.hangsFrom) {
            node.shapeArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(node.shapeArgs, {
    ...
    OrganizationSeries.prototype.drawDataLabels = function () {
        ...
        if (dlOptions.linkTextPath && dlOptions.linkTextPath.enabled) {
            for (var _i = 0, _a = this.points; _i < _a.length; _i++) {
                var link = _a[_i];
                link.options.dataLabels = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(link.options.dataLabels, { useHTML: false });
            }
        }
     ...
     *
     * */
    OrganizationSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(SankeySeries.defaultOptions, Organization_OrganizationSeriesDefaults);
    return OrganizationSeries;
}(SankeySeries));
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(OrganizationSeries.prototype, {
