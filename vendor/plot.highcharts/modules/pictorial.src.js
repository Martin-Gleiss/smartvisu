...
})(typeof window === 'undefined' ? this : window, function(__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__448__, __WEBPACK_EXTERNAL_MODULE__960__, __WEBPACK_EXTERNAL_MODULE__512__, __WEBPACK_EXTERNAL_MODULE__820__, __WEBPACK_EXTERNAL_MODULE__184__, __WEBPACK_EXTERNAL_MODULE__540__) {
...
function composePatternFill(ChartClass, SeriesClass, SVGRendererClass) {
    ...
    if (!pointProto.calculatePatternDimensions) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'endResize', onChartEndResize);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'redraw', onChartRedraw);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(pointProto, {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'render', onSeriesRender);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(SeriesClass.prototype, 'getColor', wrapSeriesGetColor);
        // Pattern scale corrections
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'afterRender', onPatternScaleCorrection);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'mapZoomComplete', onPatternScaleCorrection);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(SVGRendererClass.prototype, {
            addPattern: rendererAddPattern
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SVGRendererClass, 'complexColor', onRendererComplexColor);
    }
}
/**
    ...
    if (patterns.length) {
        ...
        for (var _i = 0, patterns_1 = patterns; _i < patterns_1.length; _i++) {
            ...
            if (!usedIds[id]) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.erase)(renderer.defIds, id);
...
function onPointAfterInit() {
    ...
    if (colorOptions &&
        ...
        // definition
        if (typeof ((_a = colorOptions.pattern) === null || _a === void 0 ? void 0 : _a.path) === 'string') {
            colorOptions.pattern.path = {
                d: colorOptions.pattern.path
            };
        }
        // Merge with series options
        point.color = point.options.color = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(point.series.options.color, colorOptions);
    }
}
/**
...
function onRendererComplexColor(args) {
    ...
    var pattern = color.pattern,
        value = 'var(--highcharts-neutral-color-80)';
    // Handle patternIndex
    ...
    if (pattern.image ||
        ...
        if (forceHashId || !pattern.id || pattern.anchorToPoint) {
            ...
            pattern = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({}, pattern);
...
function pointCalculatePatternDimensions(pattern) {
    ...
    if (pattern.image) {
        ...
        if (!bBox.width || !bBox.height) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(scaleY) && scaleY < 0) {
...
function rendererAddPattern(options, animation) {
    ...
    var rect = function (fill) { return _this
            .rect(0, 0,
        width,
        height)
            .attr({ fill: fill })
    ...
    if (options.path) {
        path = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(options.path) ?
            options.path :
            { d: options.path };
        // The background
...
function getStackMetrics(yAxis, shape) {
    var height = yAxis.len,
        y = 0;
    if (shape && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(shape.max)) {
 ...
 *
 * */
composePatternFill((highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default()), (highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()), (highcharts_SVGRenderer_commonjs_highcharts_SVGRenderer_commonjs2_highcharts_SVGRenderer_root_Highcharts_SVGRenderer_default()));
/* *
 *
 *  Constants
 *
...
var PictorialSeries = /** @class */ (function (_super) {
    ...
    PictorialSeries.prototype.animate = function (init) {
        var _a = this, chart = _a.chart, group = _a.group, animation = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.animObject)(this.options.animation), 
    ...
    PictorialSeries.prototype.getExtremes = function () {
        ...
        if (paths) {
            paths.forEach(function (path) {
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(path.max) &&
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(extremes.dataMax) &&
 ...
 *
 * */
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(PictorialSeries, 'afterRender', function () {
...
function renderStackShadow(stack) {
    ...
    if (series &&
        ...
        var xAxis = series.xAxis,
            ...
            strokeWidth = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(shadowOptions && shadowOptions.borderWidth,
...
function forEachStack(chart, callback) {
    if (chart.axes) {
        chart.axes.forEach(function (axis) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(stacks, function (type) {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(type, function (stack) {
                    callback(stack);
                });
            });
        });
