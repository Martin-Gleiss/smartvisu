...
var StreamgraphSeries = /** @class */ (function (_super) {
     ...
     *
     * */
    StreamgraphSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(AreaSplineSeries.defaultOptions, Streamgraph_StreamgraphSeriesDefaults);
    return StreamgraphSeries;
}(AreaSplineSeries));
// Reflect the dataMin property, as only dataMax is registered above
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(StreamgraphSeries, 'afterGetExtremes', function (e) {
    e.dataExtremes.dataMin = -e.dataExtremes.dataMax;
});
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(StreamgraphSeries.prototype, {
    negStacks: false
});
