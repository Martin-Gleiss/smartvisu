...
var ParetoSeries = /** @class */ (function (_super) {
        ...
        for (var _i = 0, yValues_1 = yValues; _i < yValues_1.length; _i++) {
            ...
            if (point !== null) {
                if (isSum) {
                    ...
                    percentPoints.push([
                        xValues[i],
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(sumPercent + percentPoint)
                    ]);
     ...
     *
     * */
    ParetoSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(LineSeries.defaultOptions, ParetoSeries_ParetoSeriesDefaults);
    return ParetoSeries;
}(LineSeries));
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(ParetoSeries.prototype, {
