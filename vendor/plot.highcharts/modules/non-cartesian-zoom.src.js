...
var NonCartesianSeriesZoom = /** @class */ (function () {
    ...
    NonCartesianSeriesZoom.compose = function (ChartClass, SeriesClass, TooltipClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'NonCartesianSeriesZoom')) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'afterDrawChartBox', onAfterDrawChartBox);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'transform', onTransform);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'afterSetChartSize', onAfterSetChartSize);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'getPlotBox', onGetPlotBox);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'initDataLabelsGroup', onInitDataLabelsGroup);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(TooltipClass, 'getAnchor', onGetAnchor);
        }
    };
