...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(WordcloudPoint.prototype, {
    weight: 1
});
/* *
 *
    ...
    if (!axes.length) {
        ...
        points.reduce(function (p1, p2) {
            var normals = getNormals(p1,
                ...
                if (!(0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(axes,
                function (existing) {
...
function intersectsAnyWord(point, points) {
    ...
    // intersecting.
    if (!intersects) {
        intersects = !!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(points, function (p) {
...
function getRotation(orientations, index, from, to) {
    ...
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(orientations) &&
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(index) &&
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(from) &&
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(to) &&
        orientations > 0 &&
        index > -1 &&
        to > from) {
        range = to - from;
...
function intersectionTesting(point, options) {
    ...
    while (delta !== false &&
        ...
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(delta)) {
...
function extendPlayingField(field, rectangle) {
    var height,
        ...
        extendHeight,
        result;
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(field) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(rectangle)) {
        ...
        // space for the word.
        result = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(field, {
...
function updateFieldBoundaries(field, rectangle) {
    ...
    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.left) || field.left > rectangle.left) {
        field.left = rectangle.left;
    }
    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.right) || field.right < rectangle.right) {
        field.right = rectangle.right;
    }
    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.top) || field.top > rectangle.top) {
        field.top = rectangle.top;
    }
    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(field.bottom) || field.bottom < rectangle.bottom) {
...
function correctFloat(number, precision) {
    var p = (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(precision) ? precision : 14,
...
var WordcloudSeries = /** @class */ (function (_super) {
    ...
    WordcloudSeries.prototype.deriveFontSize = function (relativeWeight, maxFontSize, minFontSize) {
        var weight = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(relativeWeight) ? relativeWeight : 0,
            max = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(maxFontSize) ? maxFontSize : 1,
            min = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(minFontSize) ? minFontSize : 1;
    ...
    WordcloudSeries.prototype.drawPoints = function () {
        ...
        for (var _a = 0, points_2 = points; _a < points_2.length; _a++) {
            ...
            var relativeWeight = 1 / maxWeight * point.weight,
                ...
                attr = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(series.pointAttribs(point, (point.selected && 'select')), {
                    align: 'center',
                    ...
                    text: point.name,
                    rotation: (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(placement.rotation) ?
                        placement.rotation :
                        void 0
                }),
    ...
    WordcloudSeries.prototype.hasData = function () {
        var series = this;
        return ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(series) &&
            series.visible === true &&
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(series.points) &&
    ...
    WordcloudSeries.prototype.getPlotBox = function (name) {
        ...
        if (group && zooming) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(group.translateX) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(group.translateY)) {
     ...
     *
     * */
    WordcloudSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ColumnSeries.defaultOptions, Wordcloud_WordcloudSeriesDefaults);
    return WordcloudSeries;
}(ColumnSeries));
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(WordcloudSeries.prototype, {
    animate: noop,
