...
(function (NodesComposition) {
    ...
    function compose(PointClass, SeriesClass) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'afterUpdate', afterUpdate);
        return SeriesClass;
    }
    ...
    function createNode(id) {
        var PointClass = this.pointClass,
            ...
            id) { return (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(nodes,
        ...
        if (!node) {
            ...
            var newNode_1 = new PointClass(this, (0,
    ...
    function generatePoints() {
        ...
        this.points.forEach(function (point) {
            ...
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(point.to)) {
    ...
    function updateNode(options, redraw, animation, runEvent) {
        ...
        if (this.isNode) {
            ...
            nodeConfig = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(nodes && nodes[nodeIndex] || {}, (data === null || data === void 0 ? void 0 : data[this.index]) || {});
            // Restore link config
            if (data) {
                if (linkConfig) {
...
var NetworkgraphPoint = /** @class */ (function (_super) {
    ...
    function NetworkgraphPoint(series, options, x) {
        ...
        if (_this.series.options.draggable &&
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(_this, 'mouseOver', function () {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(this.series.chart.container, { cursor: 'move' });
            });
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(_this, 'mouseOut', function () {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.css)(this.series.chart.container, { cursor: 'default' });
            });
        }
        return _this;
    }
    ...
    NetworkgraphPoint.prototype.isValid = function () {
        return !this.isNode || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.id);
    };
    /**
     * Redraw link's path.
     * @private
...
var NetworkgraphSeries = /** @class */ (function (_super) {
    ...
    NetworkgraphSeries.prototype.init = function (chart, options) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this, 'updatedData', function () {
            if (_this.layout) {
                _this.layout.stop();
            }
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this, 'afterUpdate', function () {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this, 'afterSimulation', function () {
            this.deferDataLabels = false;
            this.drawDataLabels();
        });
        return this;
    ...
    NetworkgraphSeries.prototype.markerAttribs = function (point, state) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(point.plotY)) {
            attribs.y = 0;
        }
    ...
    NetworkgraphSeries.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(Series.defaultOptions, Networkgraph_NetworkgraphSeriesDefaults);
    return NetworkgraphSeries;
}(Series));
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(NetworkgraphSeries.prototype, {
