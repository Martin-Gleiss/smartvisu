...
function compose(ChartClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'Debugger')) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()), 'displayError', onHighchartsDisplayError);
...
function onHighchartsDisplayError(e) {
    ...
    var chart = (e.chart ||
            (0,
        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(this.charts.slice().reverse(),
        function (c) { return !!c; }));
    if (!chart) {
        return;
    }
    ...
    if (options && options.displayErrors && renderer) {
        chart.errorElements = [];
        msg = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(code) ?
