...
var PointAndFigureSeries = /** @class */ (function (_super) {
    ...
    PointAndFigureSeries.compose = function (SVGRendererClass) {
        if (pushUnique(PointAndFigureSeries_composed, 'pointandfigure')) {
    ...
    PointAndFigureSeries.prototype.getProcessedData = function () {
        ...
        var series = this, modified = this.dataTable.getModified(), options = series.options, xData = series.getColumn('x', true), yData = series.getColumn('y', true), boxSize = options.boxSize, calculatedBoxSize = isNumber(boxSize) ?
