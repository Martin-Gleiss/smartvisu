...
function Boost_compose(ChartClass, AxisClass, SeriesClass, seriesTypes, PointClass, ColorClass) {
    ...
    if (!wglMode) {
        if (typeof (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).initCanvasBoost !== 'undefined') {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)(26);
        }
    }
    ...
    // div while `isPanning`.
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(AxisClass, 'setExtremes', function (e) {
        var _a;
        var _b,
            _c;
