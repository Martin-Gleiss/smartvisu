    ...
    hexagon: {
        ...
        translate: function () {
            ...
            for (var _i = 0, _b = series.points; _i < _b.length; _i++) {
                var point = _b[_i];
                var x1 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(xAxis.len -
                    ...
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(xAxis.len -
                        xAxis.translate(point.x + xPad * 2, 0, 1, 0, 1)), -xAxis.len, 2 * xAxis.len),
                    y1 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(yAxis.translate(point.y - yPad, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len),
                    y2 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(yAxis.translate(point.y, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len),
                    y3 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(yAxis.translate(point.y + yPad, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len);
            ...
            for (var _i = 0, _a = series.points; _i < _a.length; _i++) {
                ...
                var x1 = (0,
                    ...
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.round(xAxis.len -
                        xAxis.translate(point.x + xPad, 0, 1, 0, 0)), -xAxis.len, 2 * xAxis.len),
                    y1 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.round(yAxis.translate(point.y - yPad, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len),
                    y2 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.round(yAxis.translate(point.y, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len),
                    y3 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.round(yAxis.translate(point.y + yPad, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len);
                var x2 = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.round(xAxis.len -
            ...
            for (var _i = 0, _a = series.points; _i < _a.length; _i++) {
                ...
                */
                if (!radius || forceNextRadiusCompute) {
                    colsizePx = Math.abs((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(xAxis.len -
                        xAxis.translate(point.x + colsize, 0, 1, 0, 0)), -xAxis.len, 2 * xAxis.len) - x);
                    yRadiusPx = Math.abs((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Math.floor(yAxis.translate(point.y + yRadius, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len) - y);
