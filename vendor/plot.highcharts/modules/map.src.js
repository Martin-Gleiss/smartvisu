...
(function (MapPointer) {
    ...
    function onContainerMouseWheel(e) {
        ...
        var delta = ((0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(e.wheelDelta) && -e.wheelDelta / 120) ||
                e.deltaY || e.detail;
        ...
        if (!chart.renderer.forExport &&
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(navOptions.buttons, function (buttonOptions, n) {
                ...
                if (!chart.hasLoaded) {
                    ...
                    var unbind_1 = (0,
                        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart, 'load',
                        function () {
...
var MapPoint = /** @class */ (function (_super) {
     ...
     * @private
     */
    MapPoint.prototype.applyOptions = function (options, x, isMock) {
        var _a;
        ...
        if (series.mapData && series.mapMap) {
            ...
            if (mapPoint) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(point, __assign(__assign({}, mapPoint), { name: (_a = point.name) !== null && _a !== void 0 ? _a : mapPoint.name }));
            }
    ...
    MapPoint.prototype.zoomTo = function (animOptions) {
        ...
        if (mapView && bounds) {
            var inset = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(point.insetIndex) &&
    ...
    Projection.prototype.cutOnAntimeridian = function (poly, isPolygon) {
        ...
        for (var i = 0, iEnd = poly.length; i < iEnd; ++i) {
            ...
            (lon1 < -90 || lon1 > 90) &&
                ...
                var fraction = (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)((antimeridian - (lon1 + 360) % 360) /
...
var MapView = /** @class */ (function () {
    ...
    function MapView(chart, options) {
        ...
        var o = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(Maps_MapViewDefaults,
            this.recommendedMapView,
            options);
        ...
        this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart, 'afterSetChartSize', function () {
            ...
            if (_this.minZoom === void 0 || // When initializing the chart
                ...
                !_this.chart.hasRendered &&
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(_this.userOptions.zoom)) {
                    _this.zoom = _this.userOptions.zoom;
                }
                if (_this.userOptions.center) {
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, _this.center, _this.userOptions.center);
                }
            }
        }));
        this.setUpEvents();
    ...
    MapView.mergeInsets = function (a, b) {
        ...
        var insetsObj = (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(toObject(a),
            toObject(b)),
            insets = Object
                .keys(insetsObj)
    ...
    MapView.prototype.createInsets = function () {
        ...
        if (insets) {
            insets.forEach(function (item) {
                var inset = new MapViewInset(_this, (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.insetOptions,
                    item));
    ...
    MapView.prototype.setUpEvents = function () {
                ...
                if (projection.options.name === 'Orthographic' &&
                    ...
                    if (mouseDownRotation) {
                        var lon = (mouseDownX - chartX) * ratio -
                                mouseDownRotation[0],
                            lat = (0,
                            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(-mouseDownRotation[1] -
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart, 'selection', function (evt) {
            // Zoom in
...
var MapViewInset = /** @class */ (function (_super) {
    ...
    function MapViewInset(mapView, options) {
        ...
        _this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ center: [0, 0] }, mapView.options.insetOptions, options);
        _this.allBounds = [];
        ...
        if (coordinates) {
            ...
            if (options.units === 'percent') {
                var relativeTo_1 = options.relativeTo === 'mapBoundingBox' &&
                        mapView.getMapBBox() ||
                        (0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.plotBox, { x: 0,
                    y: 0 });
                polygon = polygon.map(function (xy) { return [
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)("" + xy[0] + "%", relativeTo_1.width, relativeTo_1.x),
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)("" + xy[1] + "%", relativeTo_1.height, relativeTo_1.y)
                ]; });
            }
            return {
                type: 'Polygon',
    ...
    MapViewInset.prototype.render = function () {
        ...
        if (borderPath && mapView.group) {
            ...
            var d = (borderPath.coordinates || []).reduce(function (d,
                ...
                y = point[1];
                    if (options.units === 'percent') {
                        x = chart.plotLeft + (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)("" + x + "%", field_1.width, field_1.x);
                        y = chart.plotTop + (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)("" + y + "%", field_1.height, field_1.y);
                    }
                    x = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(x, strokeWidth_1);
                    y = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(y, strokeWidth_1);
...
var MapSeries = /** @class */ (function (_super) {
                    ...
                    if (!point.bounds) {
                        ...
                        if (bounds) {
                            ...
                            var midX_1 = bounds.midX,
                                midY_1 = bounds.midY;
                            if (insets_1 && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(midX_1) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(midY_1)) {
                                var inset = (0,
                                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(insets_1,
    ...
    MapSeries.prototype.pointAttribs = function (point, state) {
        var _a,
            _b,
            _c;
        var _d = ((point === null || point === void 0 ? void 0 : point.series) || this).chart,
            mapView = _d.mapView,
            styledMode = _d.styledMode;
        var attr = styledMode && point ?
                this.colorAttribs(point) :
                ColumnSeries.prototype.pointAttribs.call(this,
            point,
            state);
        // Individual stroke width
        var pointStrokeWidth = this.getStrokeWidth((point === null || point === void 0 ? void 0 : point.options) || {});
        // Handle state specific border or line width
        if (state) {
            var stateOptions = (0,
                highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)((_a = this.options.states) === null || _a === void 0 ? void 0 : _a[state], ((_b = point === null || point === void 0 ? void 0 : point.options.states) === null || _b === void 0 ? void 0 : _b[state]) || {}),
            ...
            attr.stroke = (_c = stateOptions.borderColor) !== null && _c !== void 0 ? _c : point === null || point === void 0 ? void 0 : point.color;
        }
        ...
        // mapData.
        if ((point === null || point === void 0 ? void 0 : point.visible) === false) {
        ...
        if ((point === null || point === void 0 ? void 0 : point.isNull) && this.options.nullInteraction) {
            attr.opacity = 1;
        }
    ...
    MapSeries.prototype.matchPoints = function () {
        // #16782
        return !this.hasProcessedDataTable &&
            _super.prototype.matchPoints.apply(this, arguments);
    };
    /**
    ...
    MapSeries.prototype.getDataColumnKeys = function () {
        // No x data for maps
    ...
    MapSeries.prototype.processData = function () {
        var options = this.options,
            ...
            (0,
            highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(options.mapData,
            true) ?
        ...
        if (mapTransforms) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(mapTransforms, function (transform) {
        ...
        else if ((mapDataObject === null || mapDataObject === void 0 ? void 0 : mapDataObject.type) === 'FeatureCollection') {
        ...
        Object.entries(dataTable.columns).forEach(function (_a) {
            var key = _a[0],
                column = _a[1];
            modified.setColumn(key, column);
        });
        if (joinBy[0] === '_i') {
            modified.setColumn('_i', Array.from({ length: modified.rowCount }, function (x, i) { return i; }));
        }
        if (mapData) {
            ...
            if (joinBy[1]) {
                var joinKey = joinBy[1];
                for (var i = 0; i < modified.rowCount; i++) {
                    var mapKey = joinKey === '_i' ?
                            i :
                            (0,
                        highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getNestedProperty)(joinKey,
    ...
    MapPointSeries.prototype.translate = function () {
        ...
        if (mapView) {
            ...
            this.points.forEach(function (p) {
                ...
                var svgTransform = ((0,
                    highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(p.insetIndex) &&
...
function onLegendAfterRender() {
    if (this.bubbleLegend) {
        var items = this.allItems,
            rtl_1 = this.options.rtl,
            lines_1 = getLinesHeights(this);
        var orgTranslateX_1,
            orgTranslateY_1,
            movementX_1,
            legendItem_1,
...
var BubbleSeries_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
var BubbleSeries = /** @class */ (function (_super) {
    ...
    BubbleSeries.prototype.getRadii = function () {
        var zData = BubbleSeries_spreadArray([], this.getColumn('z', false, true), true), yData = this.getColumn('y'), radii = [];
        var len,
            i,
            value,
    ...
    BubbleSeries.prototype.translateBubble = function () {
        ...
        this.data.concat(this.condemnedPoints).forEach(function (point, i) {
            var _a;
            var _b = point.plotX,
                plotX = _b === void 0 ? 0 : _b,
                _c = point.plotY,
                plotY = _c === void 0 ? 0 : _c,
                radius = point.condemned ?
                    (((_a = point.marker) === null || _a === void 0 ? void 0 : _a.radius) || 0) :
...
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(BubbleSeries, 'updatedData', function (e) {
    delete e.target.chart.bubbleZExtremes;
});
// After removing series, delete the chart-level Z extremes cache, #17502.
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(BubbleSeries, 'remove', function (e) {
    delete e.target.chart.bubbleZExtremes;
});
// Before updating series, delete the chart-level Z extremes cache if zMin or
// zMax options are being changed, #24138.
(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(BubbleSeries, 'update', function (e) {
    var bubbleOptions = e.target.options;
...
var HeatmapSeries = /** @class */ (function (_super) {
    ...
    HeatmapSeries.prototype.init = function () {
        ...
        if (canvas) {
            this.context = canvas === null || canvas === void 0 ? void 0 : canvas.getContext('webgpu');
        }
    };
    /**
     * @private
    ...
    HeatmapSeries.prototype.translate = function () {
        ...
        for (var _i = 0, _b = series.points; _i < _b.length; _i++) {
            ...
            point.shapeType = 'path';
            point.shapeArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, { x: x, y: y, width: width, height: height }, {
