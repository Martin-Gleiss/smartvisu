...
var GeoJSONComposition_win = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).win;
...
var MapView = /** @class */ (function () {
    ...
    function MapView(chart, options) {
        ...
        var o = merge(Maps_MapViewDefaults,
            this.recommendedMapView,
            options);
...
var MapSeries = /** @class */ (function (_super) {
    ...
    MapSeries.prototype.pointAttribs = function (point, state) {
        ...
        if (state) {
            var stateOptions = merge((_a = this.options.states) === null || _a === void 0 ? void 0 : _a[state], ((_b = point.options.states) === null || _b === void 0 ? void 0 : _b[state]) || {}),
...
var InterpolationUtilities_doc = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()).doc;
/* *
 *
 *  Functions
 *
