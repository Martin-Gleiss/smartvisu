...
100;else{a*=100;d=b=0;0>a&&(b=32768,a=-a);for(;2047<a;)a>>=1,d++;0!=b&&(a=-a);b=b|a&2047|d<<11&30720;for(c=Number(b+8388608).toString(16);5>c.length;)c="0"+c}else"1.001"==b?"to"==d&&(c="8"+a):c=parseInt(a,16);return c},get:function(a){$.ajax({url:"http://"+io.adress+":"+io.port+"/cgi-bin/r?"+getForUrl,type:"GET",dataType:"json",async:!0,cache:!1}).done(function(b){widget.update(a,b[a])}).error(notify.error("Driver: eibd","Error reading item!"))},put:function(a,b){var d=io.timer_run;io.stop();$.ajax({url:"http://"+
