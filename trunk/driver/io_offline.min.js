...
dataType:"json",async:!0,cache:!1}).done(function(a){widget.plot().each(function(b){b=widget.explode($(this).attr("data-item"));for(var c=0;c<b.length;c++){var d=b[c].split(".");null==a[b[c]]&&null==widget.get(b[c])&&widget.checkseries(b[c])&&(a[b[c]]=io.demoseries(d[d.length-2],d[d.length-1],$(this).attr("data-ymin"),$(this).attr("data-ymax"),$(this).attr("data-step")))}});widget.log().each(function(a){widget.set($(this).attr("data-item"),io.demolog($(this).attr("data-count")))});$.each(a,function(a,
