...
send:function(a){1==io.socket.readyState&&io.socket.send(unescape(encodeURIComponent(JSON.stringify(a))))},monitor:function(){widget.listening()&&io.send({cmd:"monitor",items:widget.listeners()})},close:function(){io.socket.close();io.socket=null}}; 
