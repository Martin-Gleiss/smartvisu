...
$(document).delegate('a[data-widget="basic.rgb"]',{update:function(d,a){var b=$(this).attr("data-max");$("#"+this.id+" span").css("background-color","rgb("+Math.round(a[0]/b*255)+","+Math.round(a[1]/b*255)+","+Math.round(a[2]/b*255)+")")}});
...
$(document).delegate('span[data-widget="basic.shifter"]',{update:function(d,a){var b=Math.min(10*(a[0]/$(this).attr("data-max")*10+0.49).toFixed(0),100);0<b&&0!=a[1]?$("#"+this.id+" img").attr("src",$(this).attr("data-pic-on").replace("00",b)):0<b&&"_00.png"==$(this).attr("data-pic-off").substr(-7)?$("#"+this.id+" img").attr("src",$(this).attr("data-pic-off").replace("00",b)):$("#"+this.id+" img").attr("src",$(this).attr("data-pic-off"))},click:function(d){d=$(this).attr("data-item").explode();d[1]&&
io.write(d[1],0==widget.get(d[1])?1:0)}});$(document).delegate('span[data-widget="basic.shifter"] > a > img',"hover",function(d){"mouseenter"===d.type?$(this).addClass("ui-focus"):$(this).removeClass("ui-focus")});
...
$(document).delegate('div[data-widget="plot.rtr"]',{update:function(d,a){for(var b=$(this).attr("data-label").explode(),c=$(this).attr("data-axis").explode(),e=a[2],f=e[0][0],h=0,g=1;g<e.length;g++)h+=e[g-1][1]*(e[g][0]-f),f=e[g][0];h/=f-e[0][0];1>h?h*=100:100<h&&(h=h/255*100);$("#"+this.id).highcharts({chart:{type:"line"},series:[{name:b[0],data:a[0],type:"spline"},{name:b[1],data:a[1],dashStyle:"shortdot",step:"left"},{type:"pie",name:"\u2211 On: ",data:[{name:"On",y:h},{name:"Off",y:100-h,color:null}],
...
$(document).delegate('svg[data-widget="icon.meter"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*0.44*Math.PI;$("#"+this.id+" #pointer").attr("points","50,85 "+fx.rotate([15,48],b,[50,85]).toString())}});$(document).delegate('svg[data-widget="icon.shutter"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*38);fx.grid(this,b,[14,30],[86,68])}});
...
$(document).delegate('svg[data-widget="icon.windsock"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*0.45*Math.PI,c=[],c=c.concat(fx.rotate([70,40],b,[80,22]),[80,22],fx.rotate([90,40],b,[80,22]));$("#"+this.id+" #top").attr("points",c.toString());for(var e=0;3>e;e++)c=[],c=c.concat(fx.rotate([71+2*e,50+14*e],b,[80,22]),fx.rotate([89-2*e,50+14*e],b,[80,22]),fx.rotate([88-2*e,54+14*e],b,[80,22]),fx.rotate([72+2*e,54+14*e],b,[80,22])),$("#"+this.id+" #part"+e).attr("points",c.toString());
