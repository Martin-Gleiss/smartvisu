...
$(document).delegate('div[data-widget="plot.period"]',{update:function(d,a){for(var b=$(this).attr("data-label").explode(),c=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode(),h=$(this).attr("data-zoom"),g=[],k=0;k<a.length;k++)g[k]={type:"stair"!=e[k]?e[k]:"line",step:"stair"==e[k]?"left":!1,name:b[k],data:a[k],color:c[k]?c[k]:null};h?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:g,xAxis:{type:"datetime",title:{text:f[0]},
minRange:(new Date).duration(h).valueOf()},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}}):$("#"+this.id).highcharts({series:g,xAxis:{type:"datetime",title:{text:f[0]}},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}})},point:function(d,a){for(var b=0;b<a.length;b++)if(a[b]){for(var c=$("#"+this.id).highcharts(),e=0;e<a[b].length;e++)c.series[b].addPoint(a[b][e],!1,100<=c.series[b].data.length);c.redraw()}}});
