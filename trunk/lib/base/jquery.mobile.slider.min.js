...
(function(a,x){a.widget("mobile.slider",a.mobile.widget,{widgetEventPrefix:"slide",options:{theme:null,trackTheme:null,disabled:!1,initSelector:"input[type='range'], :jqmData(type='range'), :jqmData(role='slider')",mini:!1,highlight:!1},_create:function(){var d=this.element,r=a.mobile.getInheritedTheme(d,"c"),l=this.options.theme||r,r=this.options.trackTheme||r,u=d[0].nodeName.toLowerCase();this.isToggleSwitch="select"===u;var g=d.parent().is(":jqmData(role='rangeslider')"),e=this.isToggleSwitch?
"ui-slider-switch":"",f=d.attr("id"),h=a("[for='"+f+"']"),b=h.attr("id")||f+"-label",h=h.attr("id",b),t=this.isToggleSwitch?0:parseFloat(d.attr("min")),n=this.isToggleSwitch?d.find("option").length-1:parseFloat(d.attr("max")),p=d.attr("orientation"),v=window.parseFloat(d.attr("step")||1),c=this.options.mini||d.jqmData("mini")?" ui-mini":"",k=document.createElement("a"),f=a(k),m=document.createElement("div"),q=a(m),w=this.options.highlight&&!this.isToggleSwitch?function(){var b=document.createElement("div");
...
(p?"-"+p:"");m.appendChild(k);"semicircle"==p&&(e=document.createElement("div"),e.className="ui-slider-semicircle-box",c=document.createElement("div"),c.className="ui-slider-semicircle-cut",e.appendChild(c),c.appendChild(m),k=document.createElement("div"),k.className="ui-slider-semicircle-inner ui-body-"+r,c.appendChild(k),c=document.createElement("div"),c.className="ui-slider-semicircle-bottom "+(w?a.mobile.activeBtnClass:"")+" ui-btn-down-"+r,c.style.cssFloat="left",e.appendChild(c),c=document.createElement("div"),
c.className="ui-slider-semicircle-bottom ui-btn-down-"+r,c.style.cssFloat="right",e.appendChild(c),q=a(e));f.buttonMarkup({corners:!0,theme:l,shadow:!0}).attr({role:"slider","aria-valuemin":t,"aria-valuemax":n,"aria-valuenow":this._value(),"aria-valuetext":this._value(),title:this._value(),"aria-labelledby":b});a.extend(this,{slider:q,handle:f,type:u,step:v,max:n,min:t,valuebg:w,isRangeslider:g,dragging:!1,beforeStart:null,userModified:!1,mouseMoved:!1});if(this.isToggleSwitch){l=document.createElement("div");
l.className="ui-slider-inneroffset";u=0;for(b=m.childNodes.length;u<b;u++)l.appendChild(m.childNodes[u]);m.appendChild(l);f.addClass("ui-slider-handle-snapping");l=d.find("option");f=0;for(m=l.length;f<m;f++)u=f?"a":"b",b=f?" "+a.mobile.activeBtnClass:" ui-btn-down-"+r,document.createElement("div"),t=document.createElement("span"),t.className=["ui-slider-label ui-slider-label-",u,b," ui-btn-corner-all"].join(""),t.setAttribute("role","img"),t.appendChild(document.createTextNode(l[f].innerHTML)),a(t).prependTo(q);
...
_value:function(){return this.isToggleSwitch?this.element[0].selectedIndex:parseFloat(this.element.val())},_reset:function(){this.refresh(x,!1,!0)},refresh:function(d,r,l){var u=this,g=a.mobile.getInheritedTheme(this.element,"c"),e=this.options.theme||g,g=this.options.trackTheme||g,f=this.element.attr("orientation");u.slider[0].className="semicircle"==f?"ui-slider-semicircle-box":[this.isToggleSwitch?"ui-slider ui-slider-switch":"ui-slider-track"+(f?"-"+f:" ")," ui-btn-down-"+g," ui-btn-corner-all",
this.options.mini?" ui-mini":""].join("");(this.options.disabled||this.element.attr("disabled"))&&this.disable();this.value=this._value();this.options.highlight&&!this.isToggleSwitch&&0===this.slider.find(".ui-slider-bg").length&&(this.valuebg=function(){var b=document.createElement("div");b.className="ui-slider-bg "+a.mobile.activeBtnClass+" ui-btn-corner-all";return a(b).prependTo(u.slider)}());this.handle.buttonMarkup({corners:!0,theme:e,shadow:!0});var h,b,e=this.element,t=(g=!this.isToggleSwitch)?
[]:e.find("option"),n=g?parseFloat(e.attr("min")):0,p=g?parseFloat(e.attr("max")):t.length-1,v=g&&0<parseFloat(e.attr("step"))?parseFloat(e.attr("step")):1,f=e.attr("orientation");if("object"===typeof d){var c,k;b=d;c=this.slider.offset().left;k=this.slider.width();h=k/((p-n)/v);if(!this.dragging||b.pageX<c-8||b.pageX>c+k+8)return;"vertical"==f?b=Math.round((b.pageY-this.slider.offset().top)/this.slider.height()*100):"bottomup"==f?b=100-Math.round((b.pageY-this.slider.offset().top)/this.slider.height()*
100):"semicircle"==f?(c=b.pageX-this.slider.offset().left-this.slider.width()/2-2,b=-(b.pageY-this.slider.offset().top-this.slider.height()+8),b=Math.round((Math.atan2(c,b)/Math.PI*180+90)/180*100),0>b&&(b=0),100<b&&(b=100)):b=1<h?(b.pageX-c)/k*100:Math.round((b.pageX-c)/k*100)}else null==d&&(d=g?parseFloat(e.val()||0):e[0].selectedIndex),b=(parseFloat(d)-n)/(p-n)*100;if(!isNaN(b)){c=b/100*(p-n)+n;var m=(c-n)%v;c-=m;2*Math.abs(m)>=v&&(c+=0<m?v:-v);m=100/((p-n)/v);c=parseFloat(c.toFixed(5));"undefined"===
typeof h&&(h=k/((p-n)/v));1<h&&g&&(b=1/v*m*(c-n));0>b&&(b=0);100<b&&(b=100);c<n&&(c=n);c>p&&(c=p);"vertical"==f?(this.handle.css("top",b+"%"),this.valuebg&&this.valuebg.css("height",b+"%")):"bottomup"==f?(this.handle.css("top",100-b+"%"),this.valuebg&&this.valuebg.css("margin-top",(this.slider.height()*(100-b)/100).toFixed(0)+"px"),this.valuebg&&this.valuebg.css("height",b+"%")):"semicircle"==f?(h=(b/100*180-90)/180*Math.PI,this.handle.css("top",Math.round(-Math.cos(h)*(this.slider.width()/2-8)+((0==
this.slider.height()?92:this.slider.height())-4))+"px"),this.handle.css("left",Math.round(Math.sin(h)*(this.slider.width()/2-8)+(this.slider.width()/2+4))+"px"),k=(1.08*b-8).toFixed(0),this.valuebg&&this.valuebg.css("width",(1>k?1:k)+"%")):(this.handle.css("left",b+"%"),this.valuebg&&this.valuebg.css("width",b+"%"));this.handle[0].setAttribute("aria-valuenow",g?c:t.eq(c).attr("value"));this.handle[0].setAttribute("aria-valuetext",g?c:t.eq(c).getEncodedText());this.handle[0].setAttribute("title",g?
c:t.eq(c).getEncodedText());if(this._labels){h=this.handle.width()/this.slider.width()*100;var q=b&&h+(100-h)*b/100,w=100===b?0:Math.min(h+100-q,100);this._labels.each(function(){var b=a(this).is(".ui-slider-label-a");a(this).width((b?q:w)+"%")})}if(!l){l=!1;g?(l=e.val()!==c,e.val(c)):(l=e[0].selectedIndex!==c,e[0].selectedIndex=c);if(!1===this._trigger("beforechange",d))return!1;!r&&l&&e.trigger("change")}}},enable:function(){this.element.attr("disabled",!1);this.slider.removeClass("ui-disabled").attr("aria-disabled",
