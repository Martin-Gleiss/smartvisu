...
a+'"]').each(function(c){c=widget.explode($(this).attr("data-item"));for(var d=0;d<c.length;d++)c[d]==a&&(b=b.add(this))}):b=$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]');return b},is_series:function(a){a=a.split(".");return a instanceof Array&&("avg"==a[a.length-3]||"sum"==a[a.length-3]||"min"==a[a.length-3]||"max"==a[a.length-3])},redraw:function(a,b){$('[data-name*="'+a+'"]').each(function(a){$(this).trigger("update",[b])})}}; 
