...
prepare:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]').each(function(a){$("#"+this.id).highcharts()&&$("#"+this.id).highcharts().destroy()})},refresh:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').each(function(a){a=widget.get(widget.explode($(this).attr("data-item")));widget.check(a)&&$(this).trigger("update",[a])})},plot:function(a){var b=$();a?$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item*="'+
a+'"]').each(function(c){c=widget.explode($(this).attr("data-item"));for(var d=0;d<c.length;d++)c[d]==a&&(b=b.add(this))}):b=$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]');return b},is_series:function(a){a=a.split(".");return a instanceof Array&&("avg"==a[a.length-3]||"sum"==a[a.length-3]||"min"==a[a.length-3]||"max"==a[a.length-3])}}; 
