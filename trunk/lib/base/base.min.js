...
b,c){a=a.responseJSON[0];notify.add("error","ERROR",a.title,a.text);notify.display()},remove:function(a){var b=notify.messages[notify.i];$(".alert").popup("close");$(".signal").removeClass(b.level).hide();void 0!==a?delete notify.messages[a]:notify.messages={}},display:function(){var a=notify.messages[notify.i];a&&($(".alert h1").html(a.title),$(".alert p").html(a.text),$(".alert .stamp").html((new Date(a.time)).transShort()),$(".signal").addClass(a.level).html(a.signal).show())}},repeater={dir:{},
init:function(){$("[data-repeat]").each(function(a){repeater.dir[this.id]||(a=$("#"+this.id),repeater.dir[this.id]=(new Date).duration(a.attr("data-repeat")),a.trigger("repeat"),repeater.tick(this.id))})},tick:function(a){var b=new Date,c=repeater.dir[a];6E4<=c&&(c-=1E3*b.getSeconds());36E5<=c&&(c-=6E4*b.getMinutes());864E5<=c&&(c-=36E5*b.getHours());setTimeout("$('#"+a+"').trigger('repeat'); repeater.tick('"+a+"');",c)},list:function(){var a=0;$("[data-repeat]").each(function(b){a++})}},widget={buffer:{},
explode:function(a){var b=[],c=[];if(0<=a.indexOf(",")){a=a.explode();for(var d=0;d<a.length;d++)""!=a[d]&&(c[a[d]]="");for(var e in c)b.push(e)}else""!=a.trim()&&b.push(a.trim());return b},list:function(){var a=0;$("[data-item]").each(function(b){""!=$(this).attr("data-item").trim()&&a++})},check:function(a){if(a instanceof Array)for(var b=0;b<a.length;b++){if(void 0===a[b]||null==a[b])return!1}else if(void 0===a||null==a)return!1;return!0},get:function(a){if(a instanceof Array)for(var b=[],c=0;c<
a.length;c++)b.push(widget.buffer[a[c]]);else b=widget.buffer[a];return b},set:function(a,b){widget.buffer[a]instanceof Array||void 0!==b&&(widget.buffer[a]=$.isNumeric(b)?1*b:b)},update:function(a,b){if(void 0===b||widget.buffer[a]!==b||widget.buffer[a]instanceof Array&&widget.buffer[a].toString()!=b.toString())widget.set(a,b),$('[data-item*="'+a+'"]').each(function(c){c=widget.explode($(this).attr("data-item"));for(var d=0;d<c.length;d++)if(c[d]==a){var e=[];if("plot."==$(this).attr("data-widget").substr(0,
