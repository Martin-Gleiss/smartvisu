...
$(document).delegate('canvas[data-widget="basic.colordisc"]',{init:function(){var b=parseFloat($(this).attr("data-colors")),a=$(this)[0],c=100/($(this).attr("data-step")/2),d=2*(Math.PI/(b+2)),e=-(Math.PI/2)+d,f=16.875/($(this).attr("data-step")/8),m=360/b;a.width=280;a.height=280;if(a.getContext){a=a.getContext("2d");a.beginPath();a.fillStyle="#888";a.shadowColor="rgba(96,96,96,0.4)";a.shadowOffsetX=2;a.shadowOffsetY=2;a.shadowBlur=4;a.arc(139,139,139,0,2*Math.PI);a.fill();a.beginPath();a.shadowOffsetX=
0;a.shadowOffsetY=0;a.shadowBlur=0;a.fillStyle="#555";a.arc(139,139,138,0,2*Math.PI);a.fill();for(var g=0;g<=b;g++){for(var k=e+g*d,l=1,n=g*m,j=c;100>=j;j+=c)a.beginPath(),a.fillStyle=hsv2rgb(n,100,j),a.arc(139,139,l*f+f+1,k,k+d+0.01,!1),a.arc(139,139,l*f,k+d+0.01,k,!0),a.fill(),l+=1;for(j=100-c;j>=c;j-=c)a.beginPath(),a.fillStyle=hsv2rgb(n,j,100),a.arc(139,139,l*f+f+1,k,k+d+0.01,!1),a.arc(139,139,l*f,k+d+0.01,k,!0),a.fill(),l+=1}g-=1;k=e+g*d;l=1;n=g*m;for(j=c;100>=j;j+=c/2)a.beginPath(),a.fillStyle=
hsv2rgb(n,0,j),a.arc(139,139,l*f+f+1,k,k+2*d+0.01,!1),a.arc(139,139,l*f,k+2*d+0.01,k,!0),a.fill(),l+=1;a.beginPath();a.fillStyle="rgb(0,0,0)";a.arc(139,139,f+1,0,2*Math.PI);a.fill()}},click:function(b){var a=this.id.substr(0,this.id.length-5),c=$(this)[0].getContext("2d"),d=$(this).offset(),e=Math.round(b.pageX-d.left);b=Math.round(b.pageY-d.top);c=c.getImageData(e,b,1,1).data;e=$("#"+a).attr("data-max");b=$("#"+a).attr("data-item").explode();io.write(b[0],Math.round(c[0]/255*e));io.write(b[1],Math.round(c[1]/
...
$(document).delegate('div[data-widget="plot.rtr"]',{update:function(b,a){for(var c=$(this).attr("data-label").explode(),d=$(this).attr("data-axis").explode(),e=a[2],f=e[0][0],m=0,g=1;g<e.length;g++)0.5<e[g-1][1]&&(m+=e[g][0]-f),f=e[g][0];m=Math.round(100*(m/(e[g-1][0]-e[0][0])));$("#"+this.id).highcharts({chart:{type:"line"},series:[{name:c[0],data:a[0],type:"spline"},{name:c[1],data:a[1],dashStyle:"shortdot",step:"left"},{type:"pie",name:"\u2211 ",data:[{name:"On",y:m,color:e[g-1][1]?Highcharts.getOptions().colors[0]:
null},{name:"Off",y:100-m,color:!e[g-1][1]?Highcharts.getOptions().colors[2]:null}],center:["95%","90%"],size:15,showInLegend:!1,dataLabels:{enabled:!1},tooltip:{formatter:function(){return this.series.name+" xxx <b>"+this.y.transPercent()+"</b>"}}}],xAxis:{type:"datetime"},yAxis:{min:$(this).attr("data-min"),max:$(this).attr("data-max"),title:{text:d[1]}},tooltip:{formatter:function(){return this.series.name+": <b>"+this.y.transTemp()+"</b>"}}})},point:function(b,a){for(var c=0;c<a.length;c++){var d=
$("#"+this.id).highcharts();if(a[c]&&(0==c||1==c))for(var e=0;e<a[c].length;e++)d.series[c].addPoint(a[c][e],!1,100<=d.series[c].data.length);d.redraw()}}});
