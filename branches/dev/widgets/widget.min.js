...
var widget={buffer:{},explode:function(b){var a=[],c=[];if(0<=b.indexOf(",")){b=b.explode();for(var d=0;d<b.length;d++)""!=b[d]&&(c[b[d]]="")}else""!=b&&(c[b]="");for(var e in c)a.push(e);return a},listening:function(){var b=!1;0<$("[data-item]").size()&&(b=!0);return b},listeners:function(){var b=[],a=[];$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').each(function(){for(var b=widget.explode($(this).attr("data-item")),c=0;c<b.length;c++)a[b[c]]=""});for(var c in a)b.push(c);return b},
list:function(){var b=0;$("[data-item]").each(function(){""!=$(this).attr("data-item").trim()&&b++})},check:function(b){if(b instanceof Array&&1<b.length)for(var a=0;a<b.length;a++){if(void 0===b[a]||null==b[a])return!1}else if(void 0===b||null==b)return!1;return!0},get:function(b){if(b instanceof Array&&1<b.length)for(var a=[],c=0;c<b.length;c++)a.push(widget.buffer[b[c]]);else a=widget.buffer[b];return a},set:function(b,a){widget.buffer[b]instanceof Array||void 0!==a&&(widget.buffer[b]=a)},update:function(b,
a){if(void 0===a||widget.buffer[b]!==a||widget.buffer[b]instanceof Array&&widget.buffer[b].toString()!=a.toString())widget.set(b,a),$('[data-item*="'+b+'"]').each(function(){for(var c=widget.explode($(this).attr("data-item")),d=0;d<c.length;d++)if(c[d]==b){var e=[];if("plot."==$(this).attr("data-widget").substr(0,5)&&$("#"+this.id).highcharts()){if(c instanceof Array)for(var g=0;g<c.length;g++)e.push(c[g]==b?a:null);void 0!==a&&null!=a&&$(this).trigger("point",[e])}else e=widget.get(c),widget.check(e)&&
$(this).trigger("update",[e])}})},prepare:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]').each(function(){$("#"+this.id).highcharts()&&$("#"+this.id).highcharts().destroy()})},refresh:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').each(function(){var b=widget.get(widget.explode($(this).attr("data-item")));widget.check(b)&&$(this).trigger("update",[b])})},plot:function(b){var a=$();b?$('[data-widget^="plot."][data-item*="'+b+'"]').each(function(){for(var c=
widget.explode($(this).attr("data-item")),d=0;d<c.length;d++)c[d]==b&&(a=a.add(this))}):a=$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]');return a},is_series:function(b){b=b.split(".");return b instanceof Array&&("avg"==b[b.length-3]||"sum"==b[b.length-3]||"min"==b[b.length-3]||"max"==b[b.length-3])?!0:!1}};$(document).delegate('[data-widget="basic.value"]',{update:function(b,a){$("#"+this.id).html(a+" "+$(this).attr("data-unit"))}});
