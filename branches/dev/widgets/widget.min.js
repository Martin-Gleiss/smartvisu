...
$(document).delegate('div[data-widget="plot.rtr"]',{update:function(b,a){for(var c=$(this).attr("data-label").explode(),d=$(this).attr("data-axis").explode(),e=a[2],g=e[0][0],m=0,f=1;f<e.length;f++)0.5<e[f-1][1]&&(m+=e[f][0]-g),g=e[f][0];m=Math.round(100*(m/(e[f-1][0]-e[0][0])));$("#"+this.id).highcharts({chart:{type:"line"},series:[{name:c[0],data:a[0],type:"spline"},{name:c[1],data:a[1],dashStyle:"shortdot",step:"left"},{type:"pie",name:"\u2211 ",data:[{name:"On",y:m,color:e[f-1][1]?Highcharts.getOptions().colors[0]:
