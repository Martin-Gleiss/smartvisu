...
a)},update:function(b,a){if(void 0===a||widget.buffer[b]!==a||widget.buffer[b]instanceof Array&&widget.buffer[b].toString()!=a.toString())widget.set(b,a),$('[data-item*="'+b+'"]').each(function(){for(var c=widget.explode($(this).attr("data-item")),d=0;d<c.length;d++)if(c[d]==b){var e=[];if("plot."==$(this).attr("data-widget").substr(0,5)&&$("#"+this.id).highcharts()){for(var g=0;g<c.length;g++)e.push(c[g]==b?a:null);void 0!==a&&null!=a&&$(this).trigger("point",[e])}else e=widget.get(c),widget.check(e)&&
