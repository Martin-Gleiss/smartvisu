...
$.widget( "mobile.slider", $.mobile.widget, {
	...
	_create: function() {
		...
		domSlider.className = [(this.isToggleSwitch ? "ui-slider"  : "ui-slider-track") + (orientation ? "-" + orientation : " "),selectClass," ui-btn-down-",trackTheme," ui-btn-corner-all", miniClass].join( "" );
	...
	refresh: function( val, isfromControl, preventInputUpdate ) {
		...
		if (orientation == 'semicircle')
			...
			self.slider[0].className = [ (this.isToggleSwitch ? "ui-slider ui-slider-switch" : "ui-slider-track" + (orientation ? "-" + orientation : " "))," ui-btn-down-" + trackTheme,' ui-btn-corner-all', ( this.options.mini ) ? " ui-mini":""].join( "" );
