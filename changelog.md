...
- some config options can be overridden using request parameters in the URL: cache, debug, design, driver, driver_address, plot_library and svstatus - useful for quick tests
