...
// ---   widget_assistant.js   
// ----------------------------------------------------------------------------
// Version 1.1.0 - for smartvisu3.0 release
//
...
function ChangeDict(selectedDict,myKey,displayKey,sl_SendNoChange)
{
	...
	case 1:
		...
		myFilterDict = document.getElementById("filteroverlay")
	    myFilterDict.style.display = "block";
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>Items</strong>'
		break;
	case 2:
		if (sl_SendNoChange != true)
		...
		myFilterDict = document.getElementById("filteroverlay")
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor=""
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>Widgets</strong>'			
		break;
	...
	case 3:
	    ...
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor=""
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>Icons</strong>'			
		break;
	case 4:
		if (sl_SendNoChange != true)
	    ...
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor=""
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>ALL</strong>'			
		break;
	case 5:
		if (sl_SendNoChange != true)
	    ...
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor=""
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>Colors</strong>'			
		break;
	case 6:
		if (sl_SendNoChange != true)
		...
		//document.getElementById("td_selected_dict").style.backgroundColor=""
		myFilterDict = document.getElementById("filteroverlay")
	    myFilterDict.style.display = "none";
		myFilterDict.style.backgroundColor=""
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>OFF</strong>'			
		break;
	case 9:
		...
		myFilterDict = document.getElementById("filteroverlay")
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor="rebeccapurple"
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>'+myKey+'</strong>'			
		break;
	case 10:
		if (sl_SendNoChange != true)
		{ $("#select_autocomplete").val("1").change(); }
		...
		myFilterDict = document.getElementById("filteroverlay")
	    myFilterDict.style.display = "block";
		myFilterDict.style.backgroundColor="green"
		document.getElementById("filteroverlaytext").innerHTML = 'auto-complete filtered by : <br><strong>'+displayKey+'</strong>'			
		break;		
	default:
		//document.getElementById("td_selected_dict").style.backgroundColor=""
		myFilterDict = document.getElementById("filteroverlay")
...
function get_colors()
{
	...
	result = myStdColors
    /*
	 * for (i = 0; i < result.length; i++) { myCompleteDict.push({ text:
	 * "'"+result[i]+"'" , displayText: ''+result[i]+" | Color" }); }
	 */
...
function TooltipChecker(cm)
{
 ...
 braceCount =  0
 while (txtBeforeCursor.search('{{') >= 0)
	 {
	 txtBeforeCursor = txtBeforeCursor.replace("{{","")
 		braceCount++
	 }
 actColumn = actColumn - braceCount*2
 while (txtBeforeCursor.search('}}') >=0 )
 	{
	 txtBeforeCursor = txtBeforeCursor.replace("}}","")
 	}
 */
 ...
 // = removeBalancedBrackets(txtBeforeCursor)
 var myIcon =""
...
// Check if we are still in a dict
 ...
 // Special verification for nasty widget definitions - nested with same
	// dynamic Icons
 /*
	 * if (txtCode.split(actWidgetName).length > 1) { txtCode = actWidgetName +
	 * txtCode.split(actWidgetName)[txtCode.split(actWidgetName).length-1] }
	 */
 ...
 if (txtCode.search('\\(') >= 0 )// && openBracketArray.length !=
									// closeBracketArray.length)
    {
