...
function ChangeDict(selectedDict,myKey)
{
	last_Param = actParam
	...
	case 9:
		...
		document.getElementById("selected_dict").style.backgroundColor="rebeccapurple"
		break;
	default:
		document.getElementById("selected_dict").style.backgroundColor=""
		break
