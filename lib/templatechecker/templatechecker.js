...
var tplchk_checker = (function () {
	...
	checkError = function (fileObject, xhr, textStatus, errorThrown) {
		...
		var content = ['<div data-role="collapsible" data-inset="false" data-theme="a" data-content-theme="a" class="tplchk_create_pending">', 	btnRecheckAdd(fileId), xhr.responseJSON.message, '</div>'].join('');
		//result.empty().append(content);
		result.html(content);
