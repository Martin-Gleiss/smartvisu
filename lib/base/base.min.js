...
Date.prototype.duration=function(a){var b={y:307584E5,m:2592E6,w:6048E5,d:864E5,h:36E5,i:6E4,s:1E3},c=0;if(a){a=a.toLowerCase().split(" ");for(var d=0,f,e=c=0;e<a.length;e+=1)if(Number(a[e]))d=a[e];else{if(f=a[e].match(/[a-z]/)){var h=f.index;f=a[e].substr(h);0<h&&(d=a[e].substr(0,h))}else f=a[e];f&&d&&(f=b[f],c+=d*f,d=0)}0==c&&0<d&&(c=d*b.s)}return new Date(c)};
