...
widget={buffer:{},explode:function(a){var b=[],c=[];if(0<=a.indexOf(",")){a=a.explode();for(var d=0;d<a.length;d++)""!=a[d]&&(c[a[d]]="");for(var e in c)b.push(e)}else""!=a.trim()&&b.push(a.trim());return b},listening:function(){var a=!1;0<$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').size()&&(a=!0);return a},listeners:function(){var a=[],b=[];$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').each(function(a){a=widget.explode($(this).attr("data-item"));for(var c=0;c<a.length;c++)b[a[c]]=
""});for(var c in b)a.push(c);return a},list:function(){var a=0;$("[data-item]").each(function(b){""!=$(this).attr("data-item").trim()&&a++})},check:function(a){if(a instanceof Array)for(var b=0;b<a.length;b++){if(void 0===a[b]||null==a[b])return!1}else if(void 0===a||null==a)return!1;return!0},get:function(a){if(a instanceof Array)for(var b=[],c=0;c<a.length;c++)b.push(widget.buffer[a[c]]);else b=widget.buffer[a];return b},set:function(a,b){widget.buffer[a]instanceof Array||void 0!==b&&(widget.buffer[a]=
$.isNumeric(b)?1*b:b)},update:function(a,b){if(void 0===b||widget.buffer[a]!==b||widget.buffer[a]instanceof Array&&widget.buffer[a].toString()!=b.toString())widget.set(a,b),$('[data-item*="'+a+'"]').each(function(c){c=widget.explode($(this).attr("data-item"));for(var d=0;d<c.length;d++)if(c[d]==a){var e=[];if("plot."==$(this).attr("data-widget").substr(0,5)&&$("#"+this.id).highcharts()){for(var f=0;f<c.length;f++)e.push(c[f]==a?b:null);void 0!==b&&null!=b&&$(this).trigger("point",[e])}else e=widget.get(c),
widget.check(e)&&$(this).trigger("update",[e])}})},prepare:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]').each(function(a){$("#"+this.id).highcharts()&&$("#"+this.id).highcharts().destroy()})},refresh:function(){$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-item]').each(function(a){a=widget.get(widget.explode($(this).attr("data-item")));widget.check(a)&&$(this).trigger("update",[a])})},plot:function(a){var b=$();a?$('[id^="'+$.mobile.activePage.attr("id")+
'-"][data-widget^="plot."][data-item*="'+a+'"]').each(function(c){c=widget.explode($(this).attr("data-item"));for(var d=0;d<c.length;d++)c[d]==a&&(b=b.add(this))}):b=$('[id^="'+$.mobile.activePage.attr("id")+'-"][data-widget^="plot."][data-item]');return b},is_series:function(a){a=a.split(".");return a instanceof Array&&("avg"==a[a.length-3]||"sum"==a[a.length-3]||"min"==a[a.length-3]||"max"==a[a.length-3])}}; 
