...
$.widget( "mobile.slider", $.mobile.slider, {
	...
	_create: function() {
		...
		var orientation = this.orientation = this.element.attr("orientation"); // orientation (none, vertical, bottomup,...)

		this.slider.addClass("ui-slider-track-" + orientation);
		this.handle.addClass("ui-slider-handle-" + orientation);
    ...
    if (orientation === undefined)
		...
		if (orientation == 'semicircle') {
			//this._addClass( self.slider, "ui-slider-semicircle-box");
		}
		else if (orientation) {
			self.slider[0].className = [ this.isToggleSwitch ? "ui-slider ui-slider-switch ui-slider-track ui-shadow-inset" : "ui-slider-track ui-slider-track-" + orientation + " ui-shadow-inset", trackThemeClass, cornerClass, miniClass ].join( "" );
		}
		else {
			self.slider[0].className = [ this.isToggleSwitch ? "ui-slider ui-slider-switch ui-slider-track ui-shadow-inset" : "ui-slider-track ui-slider-track ui-shadow-inset", trackThemeClass, cornerClass, miniClass ].join( "" );
		}
