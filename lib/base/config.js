...
$(document).on('pagecreate', function (event, ui) {
	...
	if(event.target.id == 'config') {
		...
		var target = searchParams.get('configtarget');
		...
		$('select[name="driver"], select[name="pages"]').change(function(event) {
			...
			location.href = 'index.php?page=config&configpages=' + pages + '&configdriver=' + driver + '&configtarget=' + target + '#config_tab_' + target;
		});
