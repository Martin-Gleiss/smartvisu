...
//clean DOM when page change from config to index
$(document).on('pagecontainerchange', function(event, ui) {
	if (ui.prevPage && ui.toPage && ui.prevPage.attr('id').substring(ui.prevPage.attr('id').length -6) == 'config' && ui.toPage.attr('id').substring(ui.toPage.attr('id').length - 5) == 'index') {
		location.reload();
	}
});
