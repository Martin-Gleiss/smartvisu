...
$(document).on('pagecreate', function (event, ui) {
	...
	if(event.target.id == 'config') {
		...
		secform
			.on('submit', function() {
				var currentTab = page.find("#config_source ul li").eq($("#config_source").tabs("option", "active")).data('source');
				var sec_ssl = $(this).find('#'+currentTab+'_driver_ssl_popup').val();
				var sec_username = $(this).find('#'+currentTab+'_driver_username_popup').val();
				var sec_password = $(this).find('#'+currentTab+'_driver_password_popup').val();
