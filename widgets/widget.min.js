...
a){b.stopPropagation();var c=$("#"+this.id).highcharts(),d=c.series[2].data[0];a[0]||(a[0]=d.x);a[1]||(a[1]=d.y);c.series[2].data[0].update([1*a[0],1*a[1]],!0)}});$('div[data-widget="plot.minmaxavg"]').on({update:function(b,a){for(var c=$(this).attr("data-axis").explode(),d=$(this).attr("data-unit"),e=a[0],f=a[1],g=[],h=0;h<e.length;h++)g[h]=[e[h][0],e[h][1],f[h][1]];$("#"+this.id).highcharts({chart:{type:"columnrange",inverted:!1},series:[{data:g,enableMouseTracking:!1},{type:"line",data:a[2]}],
...
a){var c=$(this).attr("data-count");1>c&&(c=100);for(var d=a[0],e=a[1],f=0;f<d.length;f++){var g=$("#"+this.id).highcharts();g.series[0].addPoint([d[f][0],d[f][1],e[f][1]],!1,g.series[f].data.length>=c);g.series[1].addPoint(a[2][f],!1,g.series[f].data.length>=c);g.redraw()}}});$('span[data-widget="status.collapse"]').on({update:function(b,a){b.stopPropagation();0!=a[0]?($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").show().trigger("expand"),$('div[data-bind="'+$(this).attr("data-id")+
