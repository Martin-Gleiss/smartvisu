...
d+"L "+(10*f+5)+","+(85-c))}}),$(document).delegate('svg[data-widget="icon.light"]',{update:function(b,a){var c=Math.round(a[0]/$(this).attr("data-max")*10),d=1;$("#"+this.id+" g#light-rays line").each(function(){$(this).css("visibility",c>=d?"visible":"hidden");d++})}}),$.mobile.activePage.find('svg[data-widget="icon.meter"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.44*Math.PI;$("#"+this.id+" #pointer").attr("points","50,85 "+fx.rotate([15,48],c,[50,85]).toString())}}),
$.mobile.activePage.find('svg[data-widget="icon.shutter"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*38);fx.grid(this,c,[14,30],[86,68])}}),$.mobile.activePage.find('svg[data-widget="icon.ventilation"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}}),$.mobile.activePage.find('svg[data-widget="icon.volume"]').on({update:function(b,a){b.stopPropagation();
var c=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,c,[18,68],[89,50])}}),$.mobile.activePage.find('svg[data-widget="icon.windmill"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}}),$.mobile.activePage.find('svg[data-widget="icon.windrose"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([37,71],
c,[50,50]),fx.rotate([50,29],c,[50,50]));$("#"+this.id+" #pin0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([63,71],c,[50,50]),fx.rotate([50,29],c,[50,50]));$("#"+this.id+" #pin1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.windsock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.45*Math.PI,d=[],d=d.concat(fx.rotate([70,40],c,[80,22]),[80,22],fx.rotate([90,40],c,[80,22]));$("#"+this.id+
" #top").attr("points",d.toString());for(var e=0;3>e;e++)d=[],d=d.concat(fx.rotate([71+2*e,50+14*e],c,[80,22]),fx.rotate([89-2*e,50+14*e],c,[80,22]),fx.rotate([88-2*e,54+14*e],c,[80,22]),fx.rotate([72+2*e,54+14*e],c,[80,22])),$("#"+this.id+" #part"+e).attr("points",d.toString());d=[];d=d.concat(fx.rotate([70,40],c,[80,22]),fx.rotate([76,82],c,[80,22]),fx.rotate([84,82],c,[80,22]),fx.rotate([90,40],c,[80,22]));$("#"+this.id+" #part3").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.zenith"]').on({update:function(b,
