...
$(this).attr("data-max")*40/6);fx.grid(this,c,[39,68],[61,28])}}),$.mobile.activePage.find('svg[data-widget="icon.blade"]').on({update:function(b,a){b.stopPropagation();for(var c=a[0]/$(this).attr("data-max")*.4*Math.PI,d,e=0;3>=e;e++)d=[],d=d.concat(fx.rotate([37,20+20*e],c,[50,20+20*e]),fx.rotate([63,20+20*e],c,[50,20+20*e])),$("#"+this.id+" #blade"+e).attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.blade2"]').on({update:function(b,a){b.stopPropagation();for(var c=
-1*(a[0]/$(this).attr("data-max")*-.7*Math.PI+.35*Math.PI),d,e=0;3>=e;e++)d=[],d=d.concat(fx.rotate([37,20+20*e],c,[50,20+20*e]),fx.rotate([63,20+20*e],c,[50,20+20*e])),$("#"+this.id+" #blade"+e).attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.blade_z"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.5*Math.PI*-1,d=[],d=d.concat(fx.rotate([25,25],c,[50,30]),fx.rotate([45,25],c,[50,30]),fx.rotate([55,35],c,[50,30]),fx.rotate([75,35],
c,[50,30]));$("#"+this.id+" #blade0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([25,65],c,[50,70]),fx.rotate([45,65],c,[50,70]),fx.rotate([55,75],c,[50,70]),fx.rotate([75,75],c,[50,70]));$("#"+this.id+" #blade1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.blade_arc"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*-.7*Math.PI+.35*Math.PI,d;d="M "+fx.rotate([30,40],c,[50,37])+" Q "+fx.rotate([50,22],c,[50,30])+" "+fx.rotate([70,
40],c,[50,37]);$("#"+this.id+" #blade0").attr("d",d);d="M "+fx.rotate([30,80],c,[50,77])+" Q "+fx.rotate([50,62],c,[50,70])+" "+fx.rotate([70,80],c,[50,77]);$("#"+this.id+" #blade1").attr("d",d)}}),$.mobile.activePage.find('svg[data-widget="icon.clock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]%60/60*2*Math.PI;$("#"+this.id+" #hand_l").attr("points","50,50 "+fx.rotate([50,30],c,[50,50]).toString());c=5*Math.floor(a[0]/60)/60*2*Math.PI;$("#"+this.id+" #hand_s").attr("points","50,50 "+
fx.rotate([50,35],c,[50,50]).toString())}}),$.mobile.activePage.find('svg[data-widget="icon.compass"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([40,50],c,[50,50]),fx.rotate([50,25],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([40,50],c,[50,50]),fx.rotate([50,75],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin1").attr("points",d.toString())}}),
$.mobile.activePage.find('svg[data-widget="icon.graph"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*70),d=$("#"+this.id+" #graph").attr("d").substr(8),e=d.split("L");8<e.length&&e.shift();for(var d="M 15,85 ",f=1;f<e.length;f++)d+="L "+(10*f+5)+","+e[f].substr(e[f].indexOf(",")+1).trim()+" ";$("#"+this.id+" #graph").attr("d",d+"L "+(10*f+5)+","+(85-c))}}),$.mobile.activePage.find('svg[data-widget="icon.light"]').on({update:function(b,a){var c=Math.round(a[0]/
$(this).attr("data-max")*10),d=1;$("#"+this.id+" g#light-rays line").each(function(){$(this).css("visibility",c>=d?"visible":"hidden");d++})}}),$.mobile.activePage.find('svg[data-widget="icon.meter"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.44*Math.PI;$("#"+this.id+" #pointer").attr("points","50,85 "+fx.rotate([15,48],c,[50,85]).toString())}}),$.mobile.activePage.find('svg[data-widget="icon.shutter"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/
$(this).attr("data-max")*38);fx.grid(this,c,[14,30],[86,68])}}),$.mobile.activePage.find('svg[data-widget="icon.ventilation"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0).attr("begin",0)}}),$.mobile.activePage.find('svg[data-widget="icon.volume"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,c,[18,68],[89,50])}}),$.mobile.activePage.find('svg[data-widget="icon.windmill"]').on({update:function(b,
a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim1").attr("dur",0<a[0]?c:0).attr("begin",0)}}),$.mobile.activePage.find('svg[data-widget="icon.windrose"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([37,71],c,[50,50]),fx.rotate([50,29],c,[50,50]));$("#"+this.id+" #pin0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([63,
71],c,[50,50]),fx.rotate([50,29],c,[50,50]));$("#"+this.id+" #pin1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.windsock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.45*Math.PI,d=[],d=d.concat(fx.rotate([70,40],c,[80,22]),[80,22],fx.rotate([90,40],c,[80,22]));$("#"+this.id+" #top").attr("points",d.toString());for(var e=0;3>e;e++)d=[],d=d.concat(fx.rotate([71+2*e,50+14*e],c,[80,22]),fx.rotate([89-2*e,50+14*e],c,[80,22]),fx.rotate([88-
2*e,54+14*e],c,[80,22]),fx.rotate([72+2*e,54+14*e],c,[80,22])),$("#"+this.id+" #part"+e).attr("points",d.toString());d=[];d=d.concat(fx.rotate([70,40],c,[80,22]),fx.rotate([76,82],c,[80,22]),fx.rotate([84,82],c,[80,22]),fx.rotate([90,40],c,[80,22]));$("#"+this.id+" #part3").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.zenith"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*Math.PI;pt=fx.rotate([10,90],c,[50,90]);$("#"+this.id+" #sun").attr("x",
pt[0]-50);$("#"+this.id+" #sun").attr("y",pt[1]-50)}}))});
