...
a.height=280;if(a.getContext){a=a.getContext("2d");a.beginPath();a.fillStyle="#888";a.shadowColor="rgba(96,96,96,0.4)";a.shadowOffsetX=2;a.shadowOffsetY=2;a.shadowBlur=4;a.arc(139,139,139,0,2*Math.PI,!1);a.fill();a.beginPath();a.shadowOffsetX=0;a.shadowOffsetY=0;a.shadowBlur=0;a.fillStyle="#555";a.arc(139,139,138,0,2*Math.PI,!1);a.fill();for(var h,l=0;l<=b;l++){var m=e+l*d,n=1,p=l*g;for(h=c;100>=h;h+=c)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,100,h),a.arc(139,139,n*f+f+1,m,m+d+.01,!1),a.arc(139,139,
n*f,m+d+.01,m,!0),a.fill(),n+=1;for(h=100-c;h>=c;h-=c)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,h,100),a.arc(139,139,n*f+f+1,m,m+d+.01,!1),a.arc(139,139,n*f,m+d+.01,m,!0),a.fill(),n+=1}--l;m=e+l*d;n=1;p=l*g;for(h=c;100>=h;h+=c/2)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,0,h),a.arc(139,139,n*f+f+1,m,m+2*d+.01,!1),a.arc(139,139,n*f,m+2*d+.01,m,!0),a.fill(),n+=1;a.beginPath();a.fillStyle="rgb(0,0,0)";a.arc(139,139,f+1,0,2*Math.PI,!1);a.fill()}},click:function(b){b.stopPropagation();var a=this.id.substr(0,
...
{min:c[k]?c[k]:null,max:d[k]?d[k]:null,title:{text:h[k+1]},opposite:0<n[k],minPadding:.05,maxPadding:.05,endOnTick:!1,startOnTick:!1},p[k]&&(q[k].lineColor=p[k],q[k].tickColor=p[k]);l?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:r,xAxis:{type:"datetime",title:{text:h[0]},minRange:(new Date).duration(l).valueOf()},yAxis:q}):$("#"+this.id).highcharts({series:r,xAxis:{type:"datetime",title:{text:h[0]}},yAxis:q})},point:function(b,a){b.stopPropagation();var c=$(this).attr("data-count");1>c&&
(c=100);for(var d=0;d<a.length;d++)if(a[d]){for(var e=$("#"+this.id).highcharts(),f=0;f<a[d].length;f++)e.series[d].addPoint(a[d][f],!1,e.series[d].data.length>=c);e.redraw()}}});$('div[data-widget="plot.period"]').on({update:function(b,a){b.stopPropagation();for(var c=$(this).attr("data-label").explode(),d=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode(),g=$(this).attr("data-zoom"),h=[],l=0;l<a.length;l++)h[l]={type:"stair"!=e[l]?
e[l]:"line",step:"stair"==e[l]?"left":!1,name:c[l],data:a[l],color:d[l]?d[l]:null};g?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:h,xAxis:{type:"datetime",title:{text:f[0]},minRange:(new Date).duration(g).valueOf()},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}}):$("#"+this.id).highcharts({series:h,xAxis:{type:"datetime",title:{text:f[0]}},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}})},point:function(b,a){b.stopPropagation();
var c=$(this).attr("data-count");1>c&&(c=100);for(var d=0;d<a.length;d++)if(a[d]){for(var e=$("#"+this.id).highcharts(),f=0;f<a[d].length;f++)e.series[d].addPoint(a[d][f],!1,e.series[d].data.length>=c);e.redraw()}}});$('div[data-widget="plot.rtr"]').on({update:function(b,a){b.stopPropagation();for(var c=$(this).attr("data-label").explode(),d=$(this).attr("data-axis").explode(),e=a[2],f=e[0][0],g=0,h=1;h<e.length;h++)g+=e[h-1][1]*(e[h][0]-f),f=e[h][0];g/=f-e[0][0];1>g?g*=100:100<g&&(g=g/255*100);$("#"+
...
a){b.stopPropagation();var c=$("#"+this.id).highcharts(),d=c.series[2].data[0];a[0]||(a[0]=d.x);a[1]||(a[1]=d.y);c.series[2].data[0].update([1*a[0],1*a[1]],!0)}});$('div[data-widget="plot.minmaxavg"]').on({update:function(b,a){b.stopPropagation();for(var c=$(this).attr("data-axis").explode(),d=$(this).attr("data-unit"),e=a[0],f=a[1],g=[],h=0;h<e.length;h++)g[h]=[e[h][0],e[h][1],f[h][1]];$("#"+this.id).highcharts({chart:{type:"columnrange",inverted:!1},series:[{data:g,enableMouseTracking:!1},{type:"line",data:a[2]}],
xAxis:{type:"datetime",title:{text:c[0]}},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:c[1]}},plotOptions:{columnrange:{dataLabels:{enabled:!0,formatter:function(){return""!=d?parseFloat(this.y).transUnit(d):parseFloat(this.y).transFloat()}}}},tooltip:{pointFormatter:function(){var a;a=""!=d?parseFloat(this.y).transUnit(d):parseFloat(this.y).transFloat();return'<span style="color:'+this.color+'">\u00d8</span>  <b>'+a+"</b><br/>"}},legend:{enabled:!1}})},point:function(b,
a){b.stopPropagation();var c=$(this).attr("data-count");1>c&&(c=100);for(var d=a[0],e=a[1],f=0;f<d.length;f++){var g=$("#"+this.id).highcharts();g.series[0].addPoint([d[f][0],d[f][1],e[f][1]],!1,g.series[f].data.length>=c);g.series[1].addPoint(a[2][f],!1,g.series[f].data.length>=c);g.redraw()}}});$('span[data-widget="status.collapse"]').on({update:function(b,a){b.stopPropagation();0!=a[0]?($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").show().trigger("expand"),$('div[data-bind="'+$(this).attr("data-id")+
'"].ui-popup').popup("open")):($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").hide().trigger("collapse"),$('div[data-bind="'+$(this).attr("data-id")+'"].ui-popup').popup("close"))}});$('span[data-widget="status.log"]').on({update:function(b,a){b.stopPropagation();var c,d="";if(a[0]instanceof Array){for(var e=a[0].slice(0,$(this).attr("data-count")),f=0;f<e.length;f++)c='<div class="color '+e[f].level.toLowerCase()+'"></div>',c+="<h3>"+(new Date(e[f].time)).transLong()+"</h3>",
c+="<p>"+e[f].message+"</p>",d+='<li data-icon="false">'+c+"</li>";$("#"+this.id+" ul").html(d).trigger("prepare").listview("refresh").trigger("redraw")}}});$('span[data-widget="status.notify"]').on({update:function(b,a){b.stopPropagation();0!=a[0]&&(notify.add($(this).attr("data-mode"),$(this).attr("data-signal"),$("#"+this.id+" h1").html(),"<b>"+a[1]+"</b><br  />"+$("#"+this.id+" p").html()),notify.display())}});$('span[data-widget="status.message"]').on({update:function(b,a){b.stopPropagation();
0!=a[0]?($("#"+this.id+"-message p span").html(a[1]?"<b>"+a[1]+"</b><br />":""),$("#"+this.id+"-message .stamp").html(a[2]?(new Date(a[2])).transShort():(new Date).transShort()),$("#"+this.id+"-message").popup("open")):$("#"+this.id+"-message").popup("close")}});$('svg[data-widget^="icon."]').on({update:function(b,a){b.stopPropagation();a instanceof Array&&this.setAttributeNS(null,"class","icon"+(a[0]&&a[1]?" icon1":" icon0"))},click:function(b){b.stopPropagation();$(this).attr("data-item")&&(b=$(this).attr("data-item").explode(),
b[1]&&io.write(b[1],0==widget.get(b[1])?1:0))}});$('svg[data-widget="icon.arrow"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat([50,50],fx.rotate([25,50],c,[50,50]),fx.rotate([50,18],c,[50,50]),fx.rotate([75,50],c,[50,50]),[50,50]);$("#"+this.id+" #line0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([32,50],c,[50,50]),fx.rotate([32,60],c,[50,50]),fx.rotate([68,60],c,[50,50]),fx.rotate([68,50],c,[50,50]));$("#"+this.id+" #line1").attr("points",
d.toString())}});$('svg[data-widget="icon.battery"]').on({update:function(b,a){b.stopPropagation();var c=6*Math.floor(a[0]/$(this).attr("data-max")*40/6);fx.grid(this,c,[39,68],[61,28])}});$('svg[data-widget="icon.blade"]').on({update:function(b,a){b.stopPropagation();for(var c=a[0]/$(this).attr("data-max")*.4*Math.PI,d,e=0;3>=e;e++)d=[],d=d.concat(fx.rotate([37,20+20*e],c,[50,20+20*e]),fx.rotate([63,20+20*e],c,[50,20+20*e])),$("#"+this.id+" #blade"+e).attr("points",d.toString())}});$('svg[data-widget="icon.blade_z"]').on({update:function(b,
a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.5*Math.PI*-1,d=[],d=d.concat(fx.rotate([25,25],c,[50,30]),fx.rotate([45,25],c,[50,30]),fx.rotate([55,35],c,[50,30]),fx.rotate([75,35],c,[50,30]));$("#"+this.id+" #blade0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([25,65],c,[50,70]),fx.rotate([45,65],c,[50,70]),fx.rotate([55,75],c,[50,70]),fx.rotate([75,75],c,[50,70]));$("#"+this.id+" #blade1").attr("points",d.toString())}});$('svg[data-widget="icon.blade_arc"]').on({update:function(b,
a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*-.7*Math.PI+.35*Math.PI,d;d="M "+fx.rotate([30,40],c,[50,37])+" Q "+fx.rotate([50,22],c,[50,30])+" "+fx.rotate([70,40],c,[50,37]);$("#"+this.id+" #blade0").attr("d",d);d="M "+fx.rotate([30,80],c,[50,77])+" Q "+fx.rotate([50,62],c,[50,70])+" "+fx.rotate([70,80],c,[50,77]);$("#"+this.id+" #blade1").attr("d",d)}});$('svg[data-widget="icon.clock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]%60/60*2*Math.PI;$("#"+this.id+" #hand_l").attr("points",
"50,50 "+fx.rotate([50,30],c,[50,50]).toString());c=5*Math.floor(a[0]/60)/60*2*Math.PI;$("#"+this.id+" #hand_s").attr("points","50,50 "+fx.rotate([50,35],c,[50,50]).toString())}});$('svg[data-widget="icon.compass"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([40,50],c,[50,50]),fx.rotate([50,25],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([40,50],c,[50,
50]),fx.rotate([50,75],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin1").attr("points",d.toString())}});$('svg[data-widget="icon.graph"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*70),d=$("#"+this.id+" #graph").attr("d").substr(8),e=d.split("L");8<e.length&&e.shift();for(var d="M 15,85 ",f=1;f<e.length;f++)d+="L "+(10*f+5)+","+e[f].substr(e[f].indexOf(",")+1).trim()+" ";$("#"+this.id+" #graph").attr("d",d+"L "+(10*f+5)+","+(85-c))}});
$(document).delegate('svg[data-widget="icon.light"]',{update:function(b,a){var c=Math.round(a[0]/$(this).attr("data-max")*10),d=1;$("#"+this.id+" g#light-rays line").each(function(){$(this).css("visibility",c>=d?"visible":"hidden");d++})}});$('svg[data-widget="icon.meter"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.44*Math.PI;$("#"+this.id+" #pointer").attr("points","50,85 "+fx.rotate([15,48],c,[50,85]).toString())}});$('svg[data-widget="icon.shutter"]').on({update:function(b,
a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*38);fx.grid(this,c,[14,30],[86,68])}});$('svg[data-widget="icon.ventilation"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}});$('svg[data-widget="icon.volume"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,c,[18,68],[89,50])}});$('svg[data-widget="icon.windmill"]').on({update:function(b,
a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}});$('svg[data-widget="icon.windrose"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([37,71],c,[50,50]),fx.rotate([50,29],c,[50,50]));$("#"+this.id+" #pin0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([50,60],c,[50,50]),fx.rotate([63,71],c,[50,50]),fx.rotate([50,29],c,[50,
50]));$("#"+this.id+" #pin1").attr("points",d.toString())}});$('svg[data-widget="icon.windsock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.45*Math.PI,d=[],d=d.concat(fx.rotate([70,40],c,[80,22]),[80,22],fx.rotate([90,40],c,[80,22]));$("#"+this.id+" #top").attr("points",d.toString());for(var e=0;3>e;e++)d=[],d=d.concat(fx.rotate([71+2*e,50+14*e],c,[80,22]),fx.rotate([89-2*e,50+14*e],c,[80,22]),fx.rotate([88-2*e,54+14*e],c,[80,22]),fx.rotate([72+2*e,54+14*e],
c,[80,22])),$("#"+this.id+" #part"+e).attr("points",d.toString());d=[];d=d.concat(fx.rotate([70,40],c,[80,22]),fx.rotate([76,82],c,[80,22]),fx.rotate([84,82],c,[80,22]),fx.rotate([90,40],c,[80,22]));$("#"+this.id+" #part3").attr("points",d.toString())}});$('svg[data-widget="icon.zenith"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*Math.PI;pt=fx.rotate([10,90],c,[50,90]);$("#"+this.id+" #sun").attr("x",pt[0]-50);$("#"+this.id+" #sun").attr("y",pt[1]-50)}})}); 
