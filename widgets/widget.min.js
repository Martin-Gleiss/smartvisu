...
0;a.shadowOffsetY=0;a.shadowBlur=0;a.fillStyle="#555";a.arc(139,139,138,0,2*Math.PI,!1);a.fill();for(var h,l=0;l<=d;l++){var m=e+l*c,n=1,p=l*g;for(h=b;100>=h;h+=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,100,h),a.arc(139,139,n*f+f+1,m,m+c+.01,!1),a.arc(139,139,n*f,m+c+.01,m,!0),a.fill(),n+=1;for(h=100-b;h>=b;h-=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(p,h,100),a.arc(139,139,n*f+f+1,m,m+c+.01,!1),a.arc(139,139,n*f,m+c+.01,m,!0),a.fill(),n+=1}--l;m=e+l*c;n=1;p=l*g;for(h=b;100>=h;h+=b/2)a.beginPath(),a.fillStyle=
fx.hsv2rgb(p,0,h),a.arc(139,139,n*f+f+1,m,m+2*c+.01,!1),a.arc(139,139,n*f,m+2*c+.01,m,!0),a.fill(),n+=1;a.beginPath();a.fillStyle="rgb(0,0,0)";a.arc(139,139,f+1,0,2*Math.PI,!1);a.fill()}},click:function(d){var a=this.id.substr(0,this.id.length-5),b=$(this)[0].getContext("2d"),c=$(this).offset(),e=Math.round(d.pageX-c.left);d=Math.round(d.pageY-c.top);b=b.getImageData(e,d,1,1).data;e=$("#"+a).attr("data-max");d=$("#"+a).attr("data-item").explode();io.write(d[0],Math.round(b[0]/255*e));io.write(d[1],
Math.round(b[1]/255*e));io.write(d[2],Math.round(b[2]/255*e));$(this).hide();$("#"+a+"-screen").removeClass("in").addClass("hide")}});
$(document).delegate('a[data-widget="basic.dual"]',{update:function(d,a){$(this).val(a);$(this).trigger("draw")},draw:function(d){$(this).val()==$(this).attr("data-val-on")?($("#"+this.id+"-off").hide(),$("#"+this.id+"-on").show()):($("#"+this.id+"-on").hide(),$("#"+this.id+"-off").show())},click:function(d){io.write($(this).attr("data-item"),$(this).val()==$(this).attr("data-val-off")?$(this).attr("data-val-on"):$(this).attr("data-val-off"))}});
$(document).delegate('a[data-widget="basic.multistate"]',{update:function(d,a){list_val=$(this).attr("data-vals").explode();list_img=$(this).attr("data-img").explode();idx=list_val.indexOf(a.toString());$("#"+this.id+" img").attr("src",list_img[idx]);$(this).val(idx)},click:function(d){list_val=$(this).attr("data-vals").explode();old_idx=parseInt($(this).val());d=old_idx+1;d>=list_val.length&&(d=0);io.write($(this).attr("data-item"),list_val[d]);$(this).val(d)}});
...
$(document).delegate('[data-widget="basic.formula"]',{update:function(d,a){var b=0,c=0,e=$(this).attr("data-unit"),f=$(this).attr("data-formula").substring(0,3),g=$(this).attr("data-formula");if("date"==e||"time"==e||"short"==e||"long"==e)b=new Date(a[0]),$("#"+this.id).html(b.transUnit(e));else{if(-1<g.indexOf("VAR1")){for(c=0;c<a.length;c++)g=eval("formula.replace(/VAR"+(c+1)+"/g, response[i]);");b=eval(g)}else{"SUB"==f&&(b=a[c],c++);for(;c<a.length;c++)b="SUB"==f?b-a[c]:b+a[c];"AVG"==f&&(b/=c);
""!=f&&(b=eval(g.replace(/VAR/g,b).replace(/AVG/g,"").replace(/SUM/g,"").replace(/SUB/g,"")))}$("#"+this.id).html(parseFloat(b).transUnit(e))}}});$(document).delegate('a[data-widget="basic.rgb"]',{update:function(d,a){var b=$(this).attr("data-max");$("#"+this.id+" span").css("background-color","rgb("+Math.round(a[0]/b*255)+","+Math.round(a[1]/b*255)+","+Math.round(a[2]/b*255)+")")}});
...
$(document).delegate('div[data-widget="basic.shutter"]',{update:function(d,a){var b=13,c="half"==$(this).attr("data-mode")?.5:1;void 0!==a[1]&&(b=parseInt(13/c*(a[1]/$(this).attr("data-max")+c-1)));for(var e=parseInt(182*a[0]/$(this).attr("data-max")),f=12;1<=f;f--)if(14<=e){var g=13-Math.abs(b),c="height: "+(e>14*f&&13==b?14-g:15-g)+"px;",c=13!=b?c+("margin-top: "+(14<=e-15?g:parseInt(g/2))+"px;"):c+("border-top: 1px dotted "+(e>14*f?"#ccc":"#333")+";");0<b?$("#"+this.id+"-"+f).attr("class","blade-pos"):
...
$(document).delegate('span[data-widget="basic.switch"]',{update:function(d,a){$(this).val(a);$(this).trigger("draw")},draw:function(d){$(this).val()==$(this).attr("data-val-on")?($("#"+this.id+"-off").hide(),$("#"+this.id+"-on").show()):($("#"+this.id+"-on").hide(),$("#"+this.id+"-off").show())},click:function(d){io.write($(this).attr("data-item"),$(this).val()==$(this).attr("data-val-off")?$(this).attr("data-val-on"):$(this).attr("data-val-off"))}});
$(document).delegate('span[data-widget="basic.switch.v1"]',{update:function(d,a){$("#"+this.id+" img").attr("src",a==$(this).attr("data-val-on")?$(this).attr("data-pic-on"):$(this).attr("data-pic-off"))},click:function(d){$("#"+this.id+" img").attr("src")==$(this).attr("data-pic-off")?io.write($(this).attr("data-item"),$(this).attr("data-val-on")):io.write($(this).attr("data-item"),$(this).attr("data-val-off"))}});
$(document).delegate('span[data-widget="basic.switch.v1"] > a > img',"hover",function(d){"mouseenter"===d.type?$(this).addClass("ui-focus"):$(this).removeClass("ui-focus")});
...
$(document).delegate('div[data-widget="plot.multiaxis"]',{update:function(d,a){var b=[];$(this).attr("data-ymin")&&(b=$(this).attr("data-ymin").explode());var c=[];$(this).attr("data-ymax")&&(c=$(this).attr("data-ymax").explode());var e=$(this).attr("data-label").explode(),f=$(this).attr("data-color").explode(),g=$(this).attr("data-exposure").explode(),h=$(this).attr("data-axis").explode(),l=$(this).attr("data-zoom"),m=[];$(this).attr("data-assign")&&(m=$(this).attr("data-assign").explode());var n=
[];$(this).attr("data-opposite")&&(n=$(this).attr("data-opposite").explode());var p=[];$(this).attr("data-ycolor")&&(p=$(this).attr("data-ycolor").explode());for(var r=[],q=[],k=0,k=0;k<a.length;k++)r[k]={type:"stair"!=g[k]?g[k]:"line",step:"stair"==g[k]?"left":!1,name:e[k],data:a[k],color:f[k]?f[k]:null,yAxis:m[k]?m[k]-1:0};for(k=0;k<h.length-1;k++)q[k]={min:b[k]?b[k]:null,max:c[k]?c[k]:null,title:{text:h[k+1]},opposite:0<n[k],minPadding:.05,maxPadding:.05,endOnTick:!1,startOnTick:!1},p[k]&&(q[k].lineColor=
p[k],q[k].tickColor=p[k]);l?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:r,xAxis:{type:"datetime",title:{text:h[0]},minRange:(new Date).duration(l).valueOf()},yAxis:q}):$("#"+this.id).highcharts({series:r,xAxis:{type:"datetime",title:{text:h[0]}},yAxis:q})},point:function(d,a){for(var b=0;b<a.length;b++)if(a[b]){for(var c=$("#"+this.id).highcharts(),e=0;e<a[b].length;e++)c.series[b].addPoint(a[b][e],!1,100<=c.series[b].data.length);c.redraw()}}});
$(document).delegate('div[data-widget="plot.period"]',{update:function(d,a){for(var b=$(this).attr("data-label").explode(),c=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode(),g=$(this).attr("data-zoom"),h=[],l=0;l<a.length;l++)h[l]={type:"stair"!=e[l]?e[l]:"line",step:"stair"==e[l]?"left":!1,name:b[l],data:a[l],color:c[l]?c[l]:null};g?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:h,xAxis:{type:"datetime",title:{text:f[0]},
minRange:(new Date).duration(g).valueOf()},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}}):$("#"+this.id).highcharts({series:h,xAxis:{type:"datetime",title:{text:f[0]}},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}})},point:function(d,a){for(var b=0;b<a.length;b++)if(a[b]){for(var c=$("#"+this.id).highcharts(),e=0;e<a[b].length;e++)c.series[b].addPoint(a[b][e],!1,100<=c.series[b].data.length);c.redraw()}}});
$(document).delegate('div[data-widget="plot.rtr"]',{update:function(d,a){for(var b=$(this).attr("data-label").explode(),c=$(this).attr("data-axis").explode(),e=a[2],f=e[0][0],g=0,h=1;h<e.length;h++)g+=e[h-1][1]*(e[h][0]-f),f=e[h][0];g/=f-e[0][0];1>g?g*=100:100<g&&(g=g/255*100);$("#"+this.id).highcharts({chart:{type:"line"},series:[{name:b[0],data:a[0],type:"spline"},{name:b[1],data:a[1],dashStyle:"shortdot",step:"left"},{type:"pie",name:"\u2211 On: ",data:[{name:"On",y:g},{name:"Off",y:100-g,color:null}],
...
$(document).delegate('span[data-widget="status.collapse"]',{update:function(d,a){0!=a[0]?($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").show(),$('div[data-bind="'+$(this).attr("data-id")+'"].ui-popup').popup("open"),$('div[data-bind="'+$(this).attr("data-id")+'"].ui-collapsible').trigger("expand")):($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").hide(),$('div[data-bind="'+$(this).attr("data-id")+'"].ui-popup').popup("close"),$('div[data-bind="'+
$(this).attr("data-id")+'"].ui-collapsible').trigger("collapse"))}});$(document).delegate('span[data-widget="status.log"]',{update:function(d,a){var b,c="";if(a[0]instanceof Array){for(var e=a[0].slice(0,$(this).attr("data-count")),f=0;f<e.length;f++)b='<div class="color '+e[f].level.toLowerCase()+'"></div>',b+="<h3>"+(new Date(e[f].time)).transLong()+"</h3>",b+="<p>"+e[f].message+"</p>",c+='<li data-icon="false">'+b+"</li>";$("#"+this.id+" ul").html(c).trigger("prepare").listview("refresh").trigger("redraw")}}});
...
$(document).delegate('span[data-widget="status.message"]',{update:function(d,a){0!=a[0]?($("#"+this.id+"-message p span").html(a[1]?"<b>"+a[1]+"</b><br />":""),$("#"+this.id+"-message .stamp").html(a[2]?(new Date(a[2])).transShort():(new Date).transShort()),$("#"+this.id+"-message").popup("open")):$("#"+this.id+"-message").popup("close")}});
...
$(document).delegate('svg[data-widget="icon.battery"]',{update:function(d,a){var b=6*Math.floor(a[0]/$(this).attr("data-max")*40/6);fx.grid(this,b,[39,68],[61,28])}});$(document).delegate('svg[data-widget="icon.blade"]',{update:function(d,a){for(var b=a[0]/$(this).attr("data-max")*.4*Math.PI,c,e=0;3>=e;e++)c=[],c=c.concat(fx.rotate([37,20+20*e],b,[50,20+20*e]),fx.rotate([63,20+20*e],b,[50,20+20*e])),$("#"+this.id+" #blade"+e).attr("points",c.toString())}});
...
$(document).delegate('svg[data-widget="icon.light"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*10),c=1;$("#"+this.id+" g#light-rays line").each(function(){$(this).css("visibility",b>=c?"visible":"hidden");c++})}});$(document).delegate('svg[data-widget="icon.meter"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*.44*Math.PI;$("#"+this.id+" #pointer").attr("points","50,85 "+fx.rotate([15,48],b,[50,85]).toString())}});
$(document).delegate('svg[data-widget="icon.shutter"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*38);fx.grid(this,b,[14,30],[86,68])}});$(document).delegate('svg[data-widget="icon.ventilation"]',{update:function(d,a){var b=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?b:0)}});$(document).delegate('svg[data-widget="icon.volume"]',{update:function(d,a){var b=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,b,[18,68],[89,50])}});
$(document).delegate('svg[data-widget="icon.windmill"]',{update:function(d,a){var b=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?b:0)}});
...
c=[];c=c.concat(fx.rotate([70,40],b,[80,22]),fx.rotate([76,82],b,[80,22]),fx.rotate([84,82],b,[80,22]),fx.rotate([90,40],b,[80,22]));$("#"+this.id+" #part3").attr("points",c.toString())}});$(document).delegate('svg[data-widget="icon.zenith"]',{update:function(d,a){var b=a[0]/$(this).attr("data-max")*Math.PI;pt=fx.rotate([10,90],b,[50,90]);$("#"+this.id+" #sun").attr("x",pt[0]-50);$("#"+this.id+" #sun").attr("y",pt[1]-50)}}); 
