...
idx=list_val.indexOf(a.toString());$("#"+this.id+" img").attr("src",list_img[idx]);$(this).val(idx)},click:function(b){list_val=$(this).attr("data-vals").explode();old_idx=parseInt($(this).val());b=old_idx+1;b>=list_val.length&&(b=0);io.write($(this).attr("data-item"),list_val[b]);$(this).val(b)}}),$.mobile.activePage.find('select[data-widget="basic.flip"]').on({update:function(b,a){b.stopPropagation();$(this).val(0<a?"on":"off").slider("refresh")},change:function(b){io.write($(this).attr("data-item"),
...
$(this).trigger("click"),$(this).attr("timer",1),setTimeout("$('#"+this.id+"').attr('timer', 0);",400));$(this).attr("lock",0)},click:function(b){io.write($(this).attr("data-item"),$(this).val())}}),$.mobile.activePage.find('span[data-widget="basic.switch"]').on({update:function(b,a){b.stopPropagation();$(this).val(a);$(this).trigger("draw")},click:function(b){io.write($(this).attr("data-item"),$(this).val()==$(this).attr("data-val-off")?$(this).attr("data-val-on"):$(this).attr("data-val-off"))},
draw:function(b){b.stopPropagation();$(this).val()==$(this).attr("data-val-on")?($("#"+this.id+"-off").hide(),$("#"+this.id+"-on").show()):($("#"+this.id+"-on").hide(),$("#"+this.id+"-off").show())}}),$.mobile.activePage.find('span[data-widget="basic.switch.v1"]').on({update:function(b,a){b.stopPropagation();$("#"+this.id+" img").attr("src",a==$(this).attr("data-val-on")?$(this).attr("data-pic-on"):$(this).attr("data-pic-off"))},click:function(b){$("#"+this.id+" img").attr("src")==$(this).attr("data-pic-off")?
io.write($(this).attr("data-item"),$(this).attr("data-val-on")):io.write($(this).attr("data-item"),$(this).attr("data-val-off"))}}),$.mobile.activePage.find('span[data-widget="basic.switch.v1"] > a > img',"hover").on({update:function(b,a){b.stopPropagation();"mouseenter"===b.type?$(this).addClass("ui-focus"):$(this).removeClass("ui-focus")}}),$.mobile.activePage.find('span[data-widget="basic.symbol"]').on({update:function(b,a){b.stopPropagation();var c="and"==$(this).attr("data-mode");if(a instanceof
Array)for(var d=0;d<a.length;d++)c="and"==$(this).attr("data-mode")?c&&a[d]==$(this).attr("data-val"):c||a[d]==$(this).attr("data-val");else c=a==$(this).attr("data-val");$("#"+this.id+" img").attr("title",new Date);c?$("#"+this.id).show():$("#"+this.id).hide()}}),$.mobile.activePage.find('div[data-widget="basic.tank"]').on({update:function(b,a){b.stopPropagation();$("#"+this.id+" div").css("height",Math.round(180*Math.min(a/$(this).attr("data-max"),1)))}}),$.mobile.activePage.find('[data-widget="basic.text"]').on({update:function(b,
...
b.getMinutes()))}}),$.mobile.activePage.find('div[data-widget="device.codepad"]').on({keyup:function(b){13==b.keyCode&&$("#"+this.id+"-ok").click()}}),$.mobile.activePage.find('div[data-widget="device.codepad"] > div > a').on({click:function(b){var a=$(this).parent().parent();b=$("#"+a.attr("id")+"-code");var c=$(this).attr("data-val");"ok"==c?a.attr("data-val")==b.val()?($('div[data-bind="'+a.attr("data-id")+'"]').attr("data-access",(new Date).getTime()).removeClass("codepad"),setTimeout(function(){$('div[data-bind="'+
a.attr("data-id")+'"]').attr("data-access","").addClass("codepad")},(new Date).duration(a.attr("data-duration")).valueOf()),a.popup("close")):(b.val(""),$("#"+a.attr("id")).addClass("ui-focus"),setTimeout(function(){$("#"+a.attr("id")).removeClass("ui-focus")},400)):"-"==c?b.val(""):b.val(b.val()+c)}}),$.mobile.activePage.find('div[data-widget="device.rtr"] > div > a[data-icon="minus"]').on({click:function(b,a){var c=$(this).parent().parent().attr("id"),d=$("#"+c).attr("data-step"),c=$("#"+c+"set").attr("data-item"),
d=(Math.round(10*(widget.get(c)-d))/10).toFixed(1);io.write(c,d)}}),$.mobile.activePage.find('div[data-widget="device.rtr"] > div > a[data-icon="plus"]').on({click:function(b,a){var c=$(this).parent().parent().attr("id"),d=$("#"+c).attr("data-step"),c=$("#"+c+"set").attr("data-item"),d=(Math.round(10*(1*widget.get(c)+1*d))/10).toFixed(1);io.write(c,d)}}),$.mobile.activePage.find('div[data-widget="plot.comfortchart"]').on({update:function(b,a){b.stopPropagation();var c=$(this).attr("data-label").explode(),
d=$(this).attr("data-axis").explode(),e=[];e[0]={type:"area",name:c[0],lineWidth:0,data:[[17,35],[16,75],[17,85],[21,80],[25,60],[27,35],[25,19],[20,20],[17,35]]};e[1]={type:"area",name:c[1],lineWidth:0,data:[[17,75],[22.5,65],[25,33],[18.5,35],[17,75]]};e[2]={name:"point",data:[[1*a[0],1*a[1]]],marker:{enabled:!0,lineWidth:2,radius:6,symbol:"circle"},showInLegend:!1};$("#"+this.id).highcharts({series:e,xAxis:{min:10,max:35,title:{text:d[0],align:"high",margin:-2}},yAxis:{min:0,max:100,title:{text:d[1],
margin:7}},plotOptions:{area:{enableMouseTracking:!1}},tooltip:{formatter:function(){return this.x.transUnit("temp")+" / "+this.y.transUnit("%")}}})},point:function(b,a){b.stopPropagation();var c=$("#"+this.id).highcharts(),d=c.series[2].data[0];a[0]||(a[0]=d.x);a[1]||(a[1]=d.y);c.series[2].data[0].update([1*a[0],1*a[1]],!0)}}),$.mobile.activePage.find('div[data-widget="plot.multiaxis"]').on({update:function(b,a){b.stopPropagation();var c=[];$(this).attr("data-ymin")&&(c=$(this).attr("data-ymin").explode());
var d=[];$(this).attr("data-ymax")&&(d=$(this).attr("data-ymax").explode());var e=$(this).attr("data-label").explode(),f=$(this).attr("data-color").explode(),m=$(this).attr("data-exposure").explode(),g=$(this).attr("data-axis").explode(),l=$(this).attr("data-zoom"),p=[];$(this).attr("data-assign")&&(p=$(this).attr("data-assign").explode());var n=[];$(this).attr("data-opposite")&&(n=$(this).attr("data-opposite").explode());var r=[];$(this).attr("data-ycolor")&&(r=$(this).attr("data-ycolor").explode());
var t=[],q=[],k;for(k=0;k<a.length;k++)t[k]={type:"stair"!=m[k]?m[k]:"line",step:"stair"==m[k]?"left":!1,name:e[k],data:a[k],color:f[k]?f[k]:null,yAxis:p[k]?p[k]-1:0};for(k=0;k<g.length-1;k++)q[k]={min:c[k]?c[k]:null,max:d[k]?d[k]:null,title:{text:g[k+1]},opposite:0<n[k],minPadding:.05,maxPadding:.05,endOnTick:!1,startOnTick:!1},r[k]&&(q[k].lineColor=r[k],q[k].tickColor=r[k]);l?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:t,xAxis:{type:"datetime",title:{text:g[0]},minRange:(new Date).duration(l).valueOf()},
yAxis:q}):$("#"+this.id).highcharts({series:t,xAxis:{type:"datetime",title:{text:g[0]}},yAxis:q})},point:function(b,a){b.stopPropagation();var c=$(this).attr("data-count");1>c&&(c=100);for(var d=0;d<a.length;d++)if(a[d]){for(var e=$("#"+this.id).highcharts(),f=0;f<a[d].length;f++)e.series[d].addPoint(a[d][f],!1,e.series[d].data.length>=c);e.redraw()}}}),$.mobile.activePage.find('div[data-widget="plot.period"]').on({update:function(b,a){b.stopPropagation();for(var c=$(this).attr("data-label").explode(),
d=$(this).attr("data-color").explode(),e=$(this).attr("data-exposure").explode(),f=$(this).attr("data-axis").explode(),g=$(this).attr("data-zoom"),h=[],l=0;l<a.length;l++)h[l]={type:"stair"!=e[l]?e[l]:"line",step:"stair"==e[l]?"left":!1,name:c[l],data:a[l],color:d[l]?d[l]:null};g?$("#"+this.id).highcharts({chart:{zoomType:"x"},series:h,xAxis:{type:"datetime",title:{text:f[0]},minRange:(new Date).duration(g).valueOf()},yAxis:{min:$(this).attr("data-ymin"),max:$(this).attr("data-ymax"),title:{text:f[1]}}}):
...
c);g.series[1].addPoint(a[2][f],!1,g.series[f].data.length>=c);g.redraw()}}}),$.mobile.activePage.find('span[data-widget="status.collapse"]').on({update:function(b,a){b.stopPropagation();0!=a[0]?($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").show().trigger("expand"),$('div[data-bind="'+$(this).attr("data-id")+'"].ui-popup').popup("open")):($('div[data-bind="'+$(this).attr("data-id")+'"]').not(".ui-collapsible").hide().trigger("collapse"),$('div[data-bind="'+$(this).attr("data-id")+
'"].ui-popup').popup("close"))}}),$.mobile.activePage.find('span[data-widget="status.log"]').on({update:function(b,a){b.stopPropagation();var c,d="";if(a[0]instanceof Array){for(var e=a[0].slice(0,$(this).attr("data-count")),f=0;f<e.length;f++)c='<div class="color '+e[f].level.toLowerCase()+'"></div>',c+="<h3>"+(new Date(e[f].time)).transLong()+"</h3>",c+="<p>"+e[f].message+"</p>",d+='<li data-icon="false">'+c+"</li>";$("#"+this.id+" ul").html(d).trigger("prepare").listview("refresh").trigger("redraw")}}}),
$.mobile.activePage.find('span[data-widget="status.notify"]').on({update:function(b,a){b.stopPropagation();0!=a[0]&&(notify.add($(this).attr("data-mode"),$(this).attr("data-signal"),$("#"+this.id+" h1").html(),"<b>"+a[1]+"</b><br  />"+$("#"+this.id+" p").html()),notify.display())}}),$.mobile.activePage.find('span[data-widget="status.message"]').on({update:function(b,a){b.stopPropagation();0!=a[0]?($("#"+this.id+"-message p span").html(a[1]?"<b>"+a[1]+"</b><br />":""),$("#"+this.id+"-message .stamp").html(a[2]?
(new Date(a[2])).transShort():(new Date).transShort()),$("#"+this.id+"-message").popup("open")):$("#"+this.id+"-message").popup("close")}}),$.mobile.activePage.find('svg[data-widget^="icon."]').on({update:function(b,a){b.stopPropagation();a instanceof Array&&this.setAttributeNS(null,"class","icon"+(a[0]&&a[1]?" icon1":" icon0"))},click:function(b){$(this).attr("data-item")&&(b=$(this).attr("data-item").explode(),b[1]&&io.write(b[1],0==widget.get(b[1])?1:0))}}),$.mobile.activePage.find('svg[data-widget="icon.arrow"]').on({update:function(b,
a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat([50,50],fx.rotate([25,50],c,[50,50]),fx.rotate([50,18],c,[50,50]),fx.rotate([75,50],c,[50,50]),[50,50]);$("#"+this.id+" #line0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([32,50],c,[50,50]),fx.rotate([32,60],c,[50,50]),fx.rotate([68,60],c,[50,50]),fx.rotate([68,50],c,[50,50]));$("#"+this.id+" #line1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.battery"]').on({update:function(b,
a){b.stopPropagation();var c=6*Math.floor(a[0]/$(this).attr("data-max")*40/6);fx.grid(this,c,[39,68],[61,28])}}),$.mobile.activePage.find('svg[data-widget="icon.blade"]').on({update:function(b,a){b.stopPropagation();for(var c=a[0]/$(this).attr("data-max")*.4*Math.PI,d,e=0;3>=e;e++)d=[],d=d.concat(fx.rotate([37,20+20*e],c,[50,20+20*e]),fx.rotate([63,20+20*e],c,[50,20+20*e])),$("#"+this.id+" #blade"+e).attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.blade_z"]').on({update:function(b,
a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.5*Math.PI*-1,d=[],d=d.concat(fx.rotate([25,25],c,[50,30]),fx.rotate([45,25],c,[50,30]),fx.rotate([55,35],c,[50,30]),fx.rotate([75,35],c,[50,30]));$("#"+this.id+" #blade0").attr("points",d.toString());d=[];d=d.concat(fx.rotate([25,65],c,[50,70]),fx.rotate([45,65],c,[50,70]),fx.rotate([55,75],c,[50,70]),fx.rotate([75,75],c,[50,70]));$("#"+this.id+" #blade1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.blade_arc"]').on({update:function(b,
a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*-.7*Math.PI+.35*Math.PI,d;d="M "+fx.rotate([30,40],c,[50,37])+" Q "+fx.rotate([50,22],c,[50,30])+" "+fx.rotate([70,40],c,[50,37]);$("#"+this.id+" #blade0").attr("d",d);d="M "+fx.rotate([30,80],c,[50,77])+" Q "+fx.rotate([50,62],c,[50,70])+" "+fx.rotate([70,80],c,[50,77]);$("#"+this.id+" #blade1").attr("d",d)}}),$.mobile.activePage.find('svg[data-widget="icon.clock"]').on({update:function(b,a){b.stopPropagation();var c=a[0]%60/60*2*Math.PI;
$("#"+this.id+" #hand_l").attr("points","50,50 "+fx.rotate([50,30],c,[50,50]).toString());c=5*Math.floor(a[0]/60)/60*2*Math.PI;$("#"+this.id+" #hand_s").attr("points","50,50 "+fx.rotate([50,35],c,[50,50]).toString())}}),$.mobile.activePage.find('svg[data-widget="icon.compass"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([40,50],c,[50,50]),fx.rotate([50,25],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin0").attr("points",
d.toString());d=[];d=d.concat(fx.rotate([40,50],c,[50,50]),fx.rotate([50,75],c,[50,50]),fx.rotate([60,50],c,[50,50]));$("#"+this.id+" #pin1").attr("points",d.toString())}}),$.mobile.activePage.find('svg[data-widget="icon.graph"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*70),d=$("#"+this.id+" #graph").attr("d").substr(8),e=d.split("L");8<e.length&&e.shift();for(var d="M 15,85 ",f=1;f<e.length;f++)d+="L "+(10*f+5)+","+e[f].substr(e[f].indexOf(",")+
1).trim()+" ";$("#"+this.id+" #graph").attr("d",d+"L "+(10*f+5)+","+(85-c))}}),$(document).delegate('svg[data-widget="icon.light"]',{update:function(b,a){var c=Math.round(a[0]/$(this).attr("data-max")*10),d=1;$("#"+this.id+" g#light-rays line").each(function(){$(this).css("visibility",c>=d?"visible":"hidden");d++})}}),$.mobile.activePage.find('svg[data-widget="icon.meter"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*.44*Math.PI;$("#"+this.id+" #pointer").attr("points",
"50,85 "+fx.rotate([15,48],c,[50,85]).toString())}}),$.mobile.activePage.find('svg[data-widget="icon.shutter"]').on({update:function(b,a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*38);fx.grid(this,c,[14,30],[86,68])}}),$.mobile.activePage.find('svg[data-widget="icon.ventilation"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}}),$.mobile.activePage.find('svg[data-widget="icon.volume"]').on({update:function(b,
a){b.stopPropagation();var c=Math.round(a[0]/$(this).attr("data-max")*71);fx.bar(this,c,[18,68],[89,50])}}),$.mobile.activePage.find('svg[data-widget="icon.windmill"]').on({update:function(b,a){b.stopPropagation();var c=4.5*(1-a[0]/$(this).attr("data-max"))+.5;$("#"+this.id+" #anim").attr("dur",0<a[0]?c:0)}}),$.mobile.activePage.find('svg[data-widget="icon.windrose"]').on({update:function(b,a){b.stopPropagation();var c=a[0]/$(this).attr("data-max")*2*Math.PI,d=[],d=d.concat(fx.rotate([50,60],c,[50,
