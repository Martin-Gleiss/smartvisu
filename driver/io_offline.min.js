...
(new Date).duration(a+"i"),g=(new Date).getTime(),d=Math.round((g-e)/a);e<g;)a=Math.floor(3*Math.random()),b.push({time:Math.floor(e+0.2*Math.random()*d-0.1*d),level:c[a],message:f[a]}),e+=d;return b}}; 
